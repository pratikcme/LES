...
//        $this->excel->getActiveSheet()->getProtection()->setSheet(true);
        ...
        //     $objValidation3->setFormula1('"'. implode(',',$supplierList).'"');
            ...
            // $objValidation7->setFormula1('=IF(ISNUMBER(VLOOKUP(N'.$i.', $M'.$i.':$M$'.$maxRow.', 1, FALSE)), "Comparison is successful", "Comparison failed")');
        ...
        foreach ($product as $i => $value){
            foreach ($value->productVarient as $key => $v) {
               ...
               if($key == 0){
                ...
                // $objValidation2->setFormula1('=IF(ISNUMBER(VLOOKUP(N'.$k.', $H'.$k.':$M$500, 1, FALSE)), "Comparison is successful", "Comparison failed")');
