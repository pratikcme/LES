    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/index'; ?>">Home</a> / Price</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading"> Price</header>
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'price_list/price_profile'; ?>" class="btn btn-primary">Add Price</a>
                                    <a href="#" id="delete_user" class="btn btn-danger">Delete Price</a>
                                </div>
                                <table class="display table table-bordered table-striped dataTable" id="example_price"
                                   ...
                                   <!--  <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    <?php foreach ($price_result as $result){ ?>
                                        <tr class="gradeX odd">
                                            ...
                                            <td class="hidden-phone">
                                                <?php
                                                    if($result->end_price == '9999999999'){
                                                        echo '';
                                                    }else{
                                                        echo $result->end_price;
                                                    }
                                                ?>
                                            </td>
                                             <td>
                                                <a href="<?php echo base_url() . 'price_list/price_profile?id=' .$this->utility->encode($result->id); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
    ...
    function single_delete(value) {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                var id = value;
                $.ajax({
                    url: '<?php echo base_url().'price_list/single_delete_price'; ?>' ,
                    data: {
                        id: id
                    },
                    success: function (data) {
                        ...
                        if (data.status == 1) {
                            bootbox.alert("Price has been deleted successfully.", function() {
                    ...
                    error: function () {
                        alert('Failed to delete selected price.');
                    }
                });
            }
            else
    ...
    $('#delete_user').click(function() {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                ...
                $.ajax({
                    url: '<?php echo base_url().'price_list/multi_delete_price'; ?>',
                    data: { ids: ids.toString() },
                    success: function(data) {
                        if(data.status == 1) {

                            bootbox.alert("Price(s) has been deleted successfully.", function() {
                                window.location.reload(true);
                            });
                        }
                        else {
