  ...
  <div class="container">
    ...
    <nav aria-label="breadcrumb">
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page"><?= $this->lang->line('Term & Conditions') ?>
        </li>
      </ol>
    </nav>
  </div>
...
<section class="privay-policy section">
  <!-- <img src="<?= $this->theme_base_url ?>/assets/images/checkout-top-right-img.svg" alt="err" class="checkout-top-right-img">
  <img src="<?= $this->theme_base_url ?>/assets/images/checkout-mid-left-img.svg" alt="err" class="checkout-mid-left-img"> -->
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
