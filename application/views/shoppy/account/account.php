                    ...
                    <ul class="nav nav-pills" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link dashboard-tabs certificates-active-img <?= ($action_name == 'change') ? 'active' : '' ?>"
                                data-bs-toggle="pill" href="#tab-7">Change Password</a>
                        </li>
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link dashboard-tabs languge-active-img" id="delete_account"
                                data-bs-toggle="pill" href="#tab-6"><?= $this->lang->line('Delete Account') ?></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="tab-content">
                    ...
                    <div id="tab-1" class="container tab-pane fade active show">
                        ...
                        <div class="myaccout-detail-tab">
                            ...
                            <form class="get-detials-account" id='ChangePass' enctype="multipart/form-data"
                                    ...
                                    <div class="col-xxl-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="lname"
                                                ...
                                                value="<?= $userDetails[0]->lname ?>" id="lname"
                                    ...
                                    <div class="col-xxl-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="email" class="form-control" id="email" name="email"
                                                ...
                                                value="<?= $userDetails[0]->email ?>" readonly aria-describedby="email">
                                        </div>
                                    </div>
                                    <div class="col-xxl-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="user_gst_number"
                                                ...
                                                value="<?= $userDetails[0]->user_gst_number ?>" aria-describedby="text"
                                        ...
                                        <div class="main-accordion">
                                            ...
                                            <div class="accordion-content">
                                                ...
                                                <button type="button"
                                                    ...
                                                    class="cancel-btn lg-btn cncOrder"><?= $this->lang->line('Cancel Order') ?></button>
                                                <?php } ?>
                                            </div>
                                        </div>
                                        <?php } ?>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="mywishlist-part-img">
                                        <a href="#" class="removeWishlistItem"
                                    ...
                                    <td>
                                        ...
                                        <div>
                                            <a href="javascript:"
                                                class="add-cart-btn addcartbutton_wishlist product_<?= $this->utility->safe_b64encode($value->product_id) ?> <?= $d_none ?>"
                                            ...
                                            <div class="product-detail-quentity <?= $d_show ?>">
                                                <div class="qty-container">
                                                    <button
                                                        class="qty-btn-minus dec dec_<?= $value->product_weight_id ?> whishlist_area cart-qty-minus"
                                                    ...
                                                    <button
                                                        class="qty-btn-plus inc inc_<?= $value->product_weight_id ?> cart-qty-plus"
                                                        data-product_weight_id="<?= $value->product_weight_id ?>"
                                ...
                                <div class="ship-check">
                                    <div class="form-check">
                                        <input type="checkbox"
                                            ...
                                            <?= ($value->status == '1') ? 'checked' : '' ?> id="<?= 'add' . $key ?>">
                                    </div>
                                </div>
                                <h3><?= $value->name ?></h3>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="password" class="form-control" name="new_pass" id="password_new"
                                            placeholder="<?= $this->lang->line('new password') ?>" autocomplete="off">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                ...
                                <div class="tab-save-btn">
                                    <button class="common-input-btn" type="submit"
