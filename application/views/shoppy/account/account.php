                 ...
                 <ul class="nav nav-pills" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                         <a class="nav-link dashboard-tabs certificates-active-img <?=($action_name == 'change') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-7" aria-selected="true" role="tab">Change Password</a>
                     </li>
                     <li class="nav-item">
                                         ...
                                         <div class="col-xxl-12">
                                             <div class="mb-3">
                                                 ...
                                                 <input type="text" class="form-control" name="user_gst_number"
                                                     ...
                                                     aria-describedby="text" placeholder="22AAAAA0000A1Z5">
                                             </div>
                                         </div>
                                         <div class="col-xxl-6 col-md-6">
                                             <div class="tab-select-box">
                                                 ...
                                                 <select class="form-select" name="country_code" id="country_code"
                                                     ...
                                                     <option <?=($key==$userDetails[0]->country_code)?'selected':'';?>
                                         ...
                                         <div class="col-xxl-6 col-md-6">
                                             <div class="mb-3">
                                                 ...
                                                 <input type="tel" class="form-control phone" id="phone" name="phone"
                                                     ...
                                                     value="<?=$userDetails[0]->phone?>" aria-describedby="text">
                                             </div>
                                         </div>
             ...
             <div class="modal-body">
                 <div class="accordion-content-3">
                     ...
                     <form method="post" id="RegisterForm" action="<?=base_url().'users_account/users/add_address'?>"
                         class="address-form" autocomplete="off">
                         <div class="row">
                             <div class="col-lg-12">
