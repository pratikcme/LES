                        ...
                        <div class="my-order-details">
                            <div class="tab-content">
                                <div class="accordion-items">
                                    <!-- ------sub-tab-1----- -->
                                    <div id="subtab-1" class="container tab-pane active show fade <?= ($delivered_order == 0) ? 'not_found_tab_pane' : "" ?>">
                                        <?php
                                    ...
                                    <!-- ------sub-tab-2----- -->
                                    <div id="subtab-2" class="container tab-pane fade <?= ($order_status == 0) ? 'not_found_tab_pane' : "" ?>">
                                        <?php
                                    ...
                                    <?php foreach ($wishlist as $key => $value) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ?>
                                                <div>
                                                    <a href="javascript:" class="add-cart-btn addcartbutton_wishlist product_<?= $this->utility->safe_b64encode($value->product_id) ?> <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->product_id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_weight_id) ?>"><span><i class="fa-solid fa-cart-shopping"></i></span> Add to Cart
                                                    </a>
                                                    <div class="product-detail-quentity <?= $d_show ?>">
                                                        <div class="qty-container">
                                                            <button class="qty-btn-minus dec dec_<?= $value->product_weight_id ?> whishlist_area cart-qty-minus" data-product_weight_id="<?= $value->product_weight_id ?>" type="button"><i class="fa-solid fa-minus"></i></button>
                    ...
                    <div class="myaccout-detail-tab">
                        <form id='ChangeUserPass' action="<?= base_url() . 'users_account/users/update_password' ?>" method="post">
                            <div class="row">
                                ...
                                <div class="tab-save-btn">
                                    <button class="common-input-btn" type="submit" id="btnChangeUserPass"><?= $this->lang->line('Change Password') ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
