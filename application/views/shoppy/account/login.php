        ...
        <div class="row">
            ...
            <div class="col-xxl-6 col-lg-6 col-md-12 d-flex align-items-center">
                ...
                <div class="login-left-content">
                    ...
                    <form class="login-deatils-wrapper" id="LoginForm" action="<?= base_url() . 'login' ?>"
                        method="post">
                        ...
                        <div class="log-in-btn">
                            <a href="<?= $googleUrl ?>" class="google-btn"><span><img
                                        src="<?= base_url() . 'public/shoppy/assets/img/' ?>my-account/google-btn.svg"
                                        alt="err"></span>Login with
                                Google</a>
                            <a href="<?= base_url() . 'login/fb_login' ?>" class="facebook-btn"><span><i
                                        class="fa-brands fa-facebook"></i></span>Login with Facebook</a>
                        </div>
                        <h3>Don’t have an account? <a
