                                    ...
                                    <div class="time-picker">
                                        ...
                                        <form class="time-wrapper">
                                            <?php foreach ($time_slot as $key => $value) { ?>
                                                <div class="form-check">
                                                    <input class="time_slot_checked" type="radio" id="<?= 'time' . $key ?>" name="time_slot" value=" <?= $value->id ?>" <?= ($value->id == $time_slot[0]->id) ? 'checked' : '' ?>>
                            ...
                            foreach ($mycart as $key => $value) { ?>
                                <div class="order-wrapper">
                                    ...
                                    <div class="order-wrapper-text">
                                        <h4><a href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->product_id) . '/' . $this->utility->safe_b64encode($value->product_weight_id) ?>"><?= $value->product_name . ' ' . $value->weight_no . ' ' . $value->weight_name ?></a>
                                        </h4>
