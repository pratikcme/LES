...
<div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
        <?php
        foreach ($banner as $key => $value) { ?>
            <section class="hero-sections carousel-item <?= ($key == 0) ? "active" : "" ?>" style="background-image: url('<?= base_url() . 'public/images/' . $this->folder . 'web_banners/' . $value->web_banner_image ?>');">
                <svg class="left-bg" data-name="Layer 1" xmlns="<?= $this->theme_base_url . '/assets/img/home/banner-left-bg.svg' ?>" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 150.6 125.24">
                    <defs>
                        <style>
                            .left-bg {
                                fill: none;
                ...
                <svg class="right-bg" data-name="Layer 1" xmlns="<?= $this->theme_base_url . '/assets/img/home/banner-right-bg.svg' ?>" xmlns:xlink="<?= $this->theme_base_url . '/assets/img/home/banner-right-bg.svg' ?>" viewBox="0 0 353.33 207.47">
                    <defs>
                        <style>
                            .right-bg {
                                fill: none;
            ...
            ?>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-6">
                    <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($category[2]->id) ?>">
                        <div class="categories">
                            <div class="category-img">
                                <img src="<?= base_url() . 'public/images/' . $this->folder . 'category/' . $category[2]->image ?>" alt="category-img">
                            </div>
                            <div class="category-name">
            ...
            ?>
                <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12">
                    <div class="box-gap">
                        ...
                        ?>
                                <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>" class="<?= $key == 2 ? 'kids-im' : 'acce-im' ?>">
                                    <div class="categories">
                                ...
                                <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6 col-6 mb-4 wow fadeInDown" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                                    ...
                                    <div class="product-card  <?= ($value->varientQuantity == '0') ? 'out-of-stock' : '' ?>">
                                        ...
                                        <div class="product-content">
                                            ...
                                            <div>
                                                <button type="button" class="add-cart-btn addcartbutton product_<?= $this->utility->safe_b64encode($value->id) ?> <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->pw_id) ?>"><span><i class="fa-solid fa-cart-shopping"></i></span><?= $this->lang->line('add to cart') ?>
                                                </button>
                                            </div>
                                            ...
                                            <div class="product-detail-quentity add-cart-btns <?= $d_show ?>">
                                                <div class="qty-container">
                                                    ...
                                                    <button class="qty-btn-plus inc inc_<?= $value->pw_id ?> cart-qty-plus" data-product_weight_id="<?= $value->pw_id ?>" type="button"><i class="fa-solid fa-plus"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
