...
<input type="hidden" name="session_vendor_id" id="session_vendor_id"
    value="<?= (isset($_SESSION['branch_id'])) ? $_SESSION["branch_id"] : '' ?>">
...
<script
    src="<?= base_url(); ?>public/<?= $_SESSION['template_name'] ?>/assets/javascript/common.js?v=<?= js_version ?>">
</script>
<?php
if (!empty($js)) {
    foreach ($js as $value) { ?>
<script
    src="<?= base_url(); ?>public/<?= $_SESSION['template_name'] ?>/assets/javascript/<?= $value . '?v=' . js_version ?>">
</script>
