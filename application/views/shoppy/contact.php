  ...
  <section class="contact-us-wrap p-100">
      <div class="container">
          ...
          <div class="contact-data">
              ...
              <form id="form" method="post" class="contact-form-wrap wow fadeInDown" data-wow-duration="1s"
                  data-wow-delay="0s" data-wow-offset="0" action="<?= base_url() . 'contact' ?>">
                  ...
                  <div class="contact-form">
                      ...
                      <div class="input-form">
                          ...
                          <div>
                              <input type="tel" name="mobile_no" class="form-control" id="phone-num"
                                  aria-describedby="phone-num"
                                  placeholder="<?= $this->lang->line('Enter phone Number'); ?>">
                      ...
                      <div class="input-form">
                          ...
                          <div>
                              <textarea name="message" id="" cols="0" rows="0"
                                  placeholder="<?= $this->lang->line('Enter Message'); ?>"></textarea>
                              <label for="message" class="error"><?= form_error('message') ?></label>
                          </div>
                      </div>
                  </div>
                  <div>
                      <button class="lg-btn contact-btn" type="submit" name="submit"
