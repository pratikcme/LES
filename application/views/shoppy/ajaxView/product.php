     ...
     <div class="product-card <?= ($value->quantity == '0') ? 'out-of-stock' : '' ?>">
         ...
         <div class="product-content">
             ...
             <div>
                 ...
                 <button type="button" class="add-cart-btn addcartbutton product_<?= $this->utility->safe_b64encode($value->id) ?>  <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_weight_id) ?>"><span><i class="fa-solid fa-cart-shopping"></i></span> <?= $this->lang->line('add to cart'); ?>
                 </button>
             </div>
