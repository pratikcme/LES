        ...
        <div class="row">
            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                <div class="product-content-part zoom">
                    ...
                    <h6 class="<?= ($varientDetails[0]->quantity > $varientDetails[0]->limited_stock) ? 'd-none' : '' ?>"
                        id="is_aval_stock">
                        <?= ($varientDetails[0]->quantity > $varientDetails[0]->limited_stock) ? $this->lang->line('In Stock') : $this->lang->line('Limited Stock') ?>
                    </h6>
                    <h3 class="wow fadeInRight notranslate" id="dynamic_price" data-wow-duration="4s" data-wow-delay="0"
                        data-wow-offset="0"><?= $this->siteCurrency ?>
                    ...
                    <div class="mt-3 mb-3 wow fadeInRight" data-wow-duration="6s" data-wow-delay="0"
                        data-wow-offset="0">
                        ...
                        <select class="product_varient_id" name="cars product_varient_id"
                            aria-label="Default select example" id="cars">
                        ...
                        <div class="product-detail-quentity <?= $d_show ?>">
                            <div class="qty-container">
                                <button
                                    class="dec qty-btn-minus cart-qty-minus dec_<?= $varientDetails[0]->id ?> decqnt"
                                    type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i
                                ...
                                <input type="text" name="qty" id="qnt"
                                    ...
                                    class="input-qty" />
                                <button class="inc inc_<?= $varientDetails[0]->id ?> qty-btn-plus cart-qty-plus incqnt"
                                    type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i
                        ...
                        <div class="product-detalis-btn">
                            ...
                            <a href="javascript:" class="add-cart-btn lg-btn <?= $d_none ?>" id="addtocart"><span><i
                                        class="fa-solid fa-cart-shopping"></i></span>Add To Cart</a>
                            <?php } ?>
                            <?php if ($isAvailable != '0') { ?>
                            <a href="javascript:" id="order_now" class="order-now"><span><i
                            ...
                            <div class=" review-content">
                                ...
                                <div class="left-content">
                                    <div class="notranslate">
                                        <h3> <strong
                                                id="avgRating"><?= (!empty($sumOfRatting) && $sumOfRatting != 0) ? round($sumOfRatting / count($product_review)) : "0" ?></strong><span>/5</span>
                                        </h3>
                                    </div>
                                    <div>
                                ...
                                <div class="right-content">
                                    <div class="enter-review-btn <?= (!empty($isVarientExist) && $countParticularUserReview == 0) ? '' : 'd-none' ?>"
                                        id="writeReviewSection">
                                        <a href="#" type="button" data-bs-toggle="modal"
                                            data-bs-target="#exampleModal"><?= $this->lang->line('Write your review') ?></a>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="rewiew-wrapper">
                                        <div class="review-left">
                                            <div class="review-img">
                                                <svg xmlns="<?= $this->theme_base_url . '/assets/images/review-icon.svg' ?>"
                                                    viewBox="0 0 24.37 23.44">
                                                    <defs>
                                                        <style>
                                                        .cls-1 {
                                                            fill: #cc833d;
                                        ...
                                        <div class="review-right">
                                            <div class="review-right-top">
                                                <span class="number-star"><?= $value->ratting ?> <span><i
...
<div class="modal fade my-review-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="reviewForm" class="modal-body rating flex-column" method="POST"
                action="<?= base_url() . 'products/productReview' ?>">

                <div class="rating-box">
                    <div class="rating">
                        <div class="rating__stars">
                            <input id="rating-1" class="rating__input rating__input-1" type="radio" name="ratetIndex"
                                value="1">
                            <input id="rating-2" class="rating__input rating__input-2" type="radio" name="ratetIndex"
                                value="2">
                            <input id="rating-3" class="rating__input rating__input-3" type="radio" name="ratetIndex"
                                value="3">
                            <input id="rating-4" class="rating__input rating__input-4" type="radio" name="ratetIndex"
                                value="4">
                            <input id="rating-5" class="rating__input rating__input-5" type="radio" name="ratetIndex"
                                value="5">
