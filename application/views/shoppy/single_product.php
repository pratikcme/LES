                        ...
                        <div class="swiper-wrapper " id="zoom_image">
                            ...
                            ?>
                                <div class="swiper-slide">
                                    <a href="#"><img data-enlargable class="drift-demo-triggers" src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>" data-zoom="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>" /></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 mb-3 wow fadeInRight" data-wow-duration="6s" data-wow-delay="0" data-wow-offset="0">
                        ...
                        <div class="product-detail-quentity <?= $d_show ?>">
                            <div class="qty-container">
                                <button class="dec qty-btn-minus cart-qty-minus dec_<?= $varientDetails[0]->id ?> decqnt" type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i class="fa-solid fa-minus"></i></button>
                                ...
                                <button class="inc inc_<?= $varientDetails[0]->id ?> qty-btn-plus cart-qty-plus incqnt" type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i class="fa-solid fa-plus"></i></button>
                            </div>
                        </div>
                            ...
                            <div class=" review-content">
                                ...
                                <div class="left-content">
                                    <div class="notranslate">
                                        <h3> <strong id="avgRating"><?= (!empty($sumOfRatting) && $sumOfRatting != 0) ? round($sumOfRatting / count($product_review)) : "0" ?></strong><span>/5</span>
                                        </h3>
                                    </div>
                                    <div>
