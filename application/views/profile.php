...
<section id="main-content">
    <form role="form" method="post" action="<?php echo base_url() . 'admin/update_profile/';  ?>" name="service_form"
        id="service_form" enctype="multipart/form-data">
            ...
            <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="customer">
                                ...
                                <div class="form-group">
                                    <label for="">currency code<span class="required" aria-required="true"> *
                                        </span></label>
                                    <select class="form-control" name="currency_code">
                                        <option value="">Select</option>
                                        <?php foreach ($currency as $key => $value) : ?>
                                        <option <?= ($app_result['currency_code'] == $value->iso) ? 'SELECTED' : ''; ?>
                                            value="
                            <?= $value->iso ?>"><?= $value->name ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control" id="email" placeholder="Email"
                                        value="<?php echo $app_result['email']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                    <label for="">Phone Number<span class="required" aria-required="true"> *
                                        </span></label>
                                    <input type="text" name="phone" class="form-control" id="phone"
                                        placeholder="Phone Number" value="<?php echo $app_result['phone_no']; ?>"
                                        maxlength="15" onkeypress="validate(event)">
                                </div>
                                <?php
                ...
                if ($vendor_id == 0) { ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="old_favicon" name="old_favicon"
                                        value="<?php echo $app_result['favicon_image']; ?>">
                                    <input type="file" accept="image/x-png,image/gif,image/jpeg"
                                        class="form-control img margin_top_input" id="favicon_image"
                                        name="favicon_image" placeholder="Select webLogo"> <span id="favicon_image"
                                        style="color: red;"></span>
                                    <div class="favicon_img_preview" style="display: none;"> <img src=""
                                            id="favicon_img_preview" width="200" height="150"> </div>
                                ...
                                <div class="img favicon" style="margin-right: 10px; margin-bottom: 20px;">
                                    <?php if ($favicon != '' && file_exists('public/client_logo/' . $favicon)) { ?> <img
                                        src="<?php echo base_url() . 'public/client_logo/' . $favicon; ?>"
                ...
                if ($vendor_id != 0) { ?>
                                <div class="form-group row ">
                                    <div class="col-md-11">
                                        <label class="margin_top_label">Enter Location :<span class="required"
                                                aria-required="true"> * </span> </label>
                                        <input type="text" id="departure_address"
                                            onFocus="initAutocomplete('departure_address')" class="dis form-control"
                                            name="location" maxlength="255"
                                            value="<?php if (isset($app_result['location'])) {
                                                                                                                                                                                  echo $app_result['location'];
                                                                                                                                                                                } else {
                                                                                                                                                                                  echo set_value('location');
                                                                                                                                                                                } ?>"
                                            placeholder="Location"> <span
                                            style="color: red;"><?php echo form_error('location'); ?></span>
                                    </div>
                                    <div class="col-md-1">
                                        <a class="display_map" href="javascript:;" onclick="initialize('departure');"
                                            title="Pick from Map"><img
                                                src="http://maps.google.com/mapfiles/ms/icons/blue-dot.png"></a>
                                    </div>
                                    <input type="hidden" id="departure_latitude" name="latitude" placeholder="Latitude"
                                        value="<?php if (isset($app_result['latitude'])) {
                                    ...
                                    <input type="hidden" id="departure_longitude" name="longitude"
                                        ...
                                        value="<?php if (isset($app_result['longitude'])) {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="gst_number" name="gst_number" class="form-control" id="gst_number"
                                        placeholder="Gst number" value="<?php echo $app_result['gst_number']; ?>">
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="selfPickUp" class="" id="selfPickUp" value="0"
                                                <?= ($app_result['selfPickUp'] == '0') ? 'checked' : '' ?>> Disabled
                                            <input type="radio" name="selfPickUp" class="" id="selfPickUp" value="1"
                                                <?= ($app_result['selfPickUp'] == 1) ? 'checked' : '' ?>>Enabled
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="selfPickupOpenClosingTiming">Self pickup open & closing Day &
                                        time</label>
                                    <textarea type="text" id="selfPickupOpenClosingTiming"
                                        name="selfPickupOpenClosingTiming"
                                        class="form-control"><?php echo @$app_result['selfPickupOpenClosingTiming'] != '' ? $app_result['selfPickupOpenClosingTiming'] : @set_value('selfPickupOpenClosingTiming'); ?></textarea>
                                ...
                                <!-- <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="isOnlinePayment" class="isOnlinePayment"
                                                id="isOnlinePayment" value="0"
                                                <?= ($app_result['isOnlinePayment'] == '0') ? 'checked' : '' ?>>
                                            Disabled
                                            <input type="radio" name="isOnlinePayment" class="isOnlinePayment"
                                                id="isOnlinePayment" value="1"
                                                <?= ($app_result['isOnlinePayment'] == 1) ? 'checked' : '' ?>>Enabled
                                        </div>
                                    </div>
                                </div>
                                //
                                 <div class="form-group">
                                    <label for="">Cash on delivery<span class="required" aria-required="true"> *
                                        </span></label>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="isCOD" class="isCOD" value="0"
                                                <?= ($app_result['isCOD'] == '0') ? 'checked' : '' ?>> Disabled
                                            <input type="radio" name="isCOD" class="isCOD" value="1"
                                                <?= ($app_result['isCOD'] == '1') ? 'checked' : '' ?>>Enabled
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Whatsapp share <span class="required" aria-required="true"> *
                                        </span></label>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="whatsapp_share" class="whatsappFlag" value="0"
                                                <?= ($app_result['whatsappFlag'] == '0') ? 'checked' : '' ?>> Disabled
                                            <input type="radio" name="whatsapp_share" class="whatsappFlag" value="1"
                                                <?= ($app_result['whatsappFlag'] == '1') ? 'checked' : '' ?>>Enabled
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="">Delivery time & date at checkout <span class="required"
                                            aria-required="true"> * </span></label>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <input type="radio" name="delivery_time_date" class="delivery_time_date"
                                                value="0"
                                                <?= ($app_result['delivery_time_date'] == '0') ? 'checked' : '' ?>> Not
                                            visible
                                            <input type="radio" name="delivery_time_date" class="delivery_time_date"
                                                value="1"
                                                <?= ($app_result['delivery_time_date'] == '1') ? 'checked' : '' ?>>
                                            Visible
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="customer padding_dropdown margin_btm">
                                <!-- <div class="form-group">
                                    ...
                                    <input type="text" name="android_version" class="form-control" id="android_version"
                                        ...
                                        value="<?php echo $app_result['android_version']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""> Android isforce:<span class="required" aria-required="true"> *
                                        </span></label>
                                    <input type="text" name="android_isforce" class="form-control" id="android_isforce"
                                        placeholder="Android is force"
                                        value="<?php echo $app_result['android_isforce']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""> Ios version :<span class="required" aria-required="true"> *
                                        </span></label>
                                    <input type="text" name="ios_version" class="form-control" id="ios_version"
                                        placeholder="ios version" value="<?php echo $app_result['ios_version']; ?>">
                                </div>
                                <div class="form-group">
                                    <label for=""> Ios isforce :<span class="required" aria-required="true"> *
                                        </span></label>
                                ...
                                <div class="form-group">
                                    <label class="margin_top_label">Web Logo :<span class="required"
                                            aria-required="true"> * </span></label>
                                    <input type="hidden" id="old_webLogo" name="old_webLogo"
                                        value="<?php echo $app_result['webLogo']; ?>">
                                    <input type="file" accept="image/x-png,image/gif,image/jpeg"
                                        class="form-control img margin_top_input" id="webLogo" name="webLogo"
                                        placeholder="Select webLogo"> <span id="webLog" style="color: red;"></span>
                                    <div class="webLogo_img_preview" style="display: none;"> <img src=""
                                            id="webLogo_img_preview" width="200" height="150"> </div>
                                    <div class="All_images"></div>
                                </div>
                                <?php $webLogo = $app_result['webLogo']; ?>
                                <div class="img img_show" style="float: left; margin-right: 10px; margin-bottom: 20px;">
                                    <?php if ($webLogo != '' && file_exists('public/client_logo/' . $webLogo)) { ?> <img
                                        src="<?php echo base_url() . 'public/client_logo/' . $webLogo; ?>"
                                        style="height: 180px; width: 200px;">
                                    <?php } ?>
                                </div>
                            </div>
              ...
              if ($vendor_id != 0) { ?>
                            <div class="customer padding_dropdown margin_btm">
                                <div class="form-group">
                                    <label for=""> Shop Name :<span class="required" aria-required="true"> *
                                        </span></label>
                                    <input type="text" name="ownername" class="form-control" id="ownername"
                                        placeholder="Shop Name" value="<?php echo $app_result['name']; ?>">
                                </div>
                                <div class="form-group">
                                    <label class="margin_top_label">Enter Address :<span class="required"
                                            aria-required="true"> * </span></label>
                                    <textarea rows="4" cols="50" name="address" placeholder="Address"
                                        class="dis form-control margin_top_input"
                                        value=""><?php if (isset($app_result['address'])) {
                                                                                                                                            echo $app_result['address'];
                                                                                                                                          } else {
                                ...
                                <div class="form-group">
                                    <label class="margin_top_label">Image :<span class="required" aria-required="true">
                                            * </span></label>
                                    <input type="hidden" id="old_file" name="old_file"
                                        value="<?php echo $app_result['image']; ?>">
                                    <input type="file" accept="image/x-png,image/gif,image/jpeg"
                                        class="form-control img margin_top_input" id="image" name="vendorimage"
                                        placeholder="Select image"> <span id="imgerr" style="color: red;"></span>
                                    <label id="image-error" class="error" for="image"
                                        style="display: inline-block;"></label>
                                    <div class="img_preview"> <img src="" id="img_preview" width="200" height="150">
                                    </div>
                                    <div class="All_images"></div>
                                    <?php $vendorimg = $app_result['image']; ?>
                                    <div class="img img_show" id="image_<?= $vendor_id; ?>"
                                        style="margin-right: 10px; margin-bottom: 20px;">
                                        <?php if ($vendorimg != '' && file_exists('public/images/' . $this->folder . 'vendor_shop/' . $vendorimg)) { ?>
                                        <img src="<?php echo base_url() . 'public/images/' . $this->folder . 'vendor_shop/' . $vendorimg; ?>"
                                            style="height: 180px; width: 200px;">
                                        <?php } ?>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="margin_top_label">Product defualt Image :<span class="required"
                                            aria-required="true"> * </span></label>
                                    <input type="hidden" id="old_file" name="default_old_file"
                                        value="<?php echo $app_result['product_default_image']; ?>">
                                    <input type="file" accept="image/x-png,image/gif,image/jpeg"
                                        class="form-control img margin_top_input" id="default_image"
                                        name="default_image" placeholder="Select image"> <span id="img_err"
                                        style="color: red;"></span>
                                    <label id="default_image_error" class="error" for="image"
                                        style="display: inline-block;"></label>
                                    <div class="default_img_preview"> <img src="" id="default_img_preview" width="200"
                                            height="150"> </div>
                                    <div class="All_images"></div>
                                </div>
                                <?php $defualt_image = $app_result['product_default_image']; ?>
                                <div class="img img_showw" id="image_<?= $vendor_id; ?>"
                                    style="margin-right: 10px; margin-bottom: 20px;">
                                    <?php if ($defualt_image != '' && file_exists('public/images/' . $this->folder . 'product_image/' . $defualt_image)) { ?>
                                    <img src="<?php echo base_url() . 'public/images/' . $this->folder . 'product_image/' . $defualt_image; ?>"
                                        style="height: 180px; width: 200px;">
                                    <?php } ?>
                                </div>
                            </div>
