                ...
                <div class="col-lg-12">
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            ...
                            <?= $value->iso ?>"><?= $value->name ?></option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fname" class="form-control" id="fname" placeholder="Name" value="<?php if (isset($app_result['owner_name'])) {
                    ...
                    if ($vendor_id != 0) { ?>
                        <div class="customer padding_dropdown margin_btm">
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="4" cols="50" name="address" placeholder="Address" class="dis form-control margin_top_input" value=""><?php if (isset($app_result['address'])) {
                            ...
                            <div class="form-group">
                                ...
                                <div class="img img_show" id="image_<?= $vendor_id; ?>" style="margin-right: 10px; margin-bottom: 20px;">
                                    <?php if ($vendorimg != '' && file_exists('public/images/' . $this->folder . 'vendor_shop/' . $vendorimg)) { ?>
                                        <img src="<?php echo base_url() . 'public/images/' . $this->folder . 'vendor_shop/' . $vendorimg; ?>" style="height: 180px; width: 200px;">
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="img img_showw" id="image_<?= $vendor_id; ?>" style="margin-right: 10px; margin-bottom: 20px;">
                                <?php if ($defualt_image != '' && file_exists('public/images/' . $this->folder . 'product_image/' . $defualt_image)) { ?>
                                    <img src="<?php echo base_url() . 'public/images/' . $this->folder . 'product_image/' . $defualt_image; ?>" style="height: 180px; width: 200px;">
                                <?php } ?>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    if ($vendor_id != 0) { ?>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="radio" name="isOnlinePayment" class="isOnlinePayment" id="isOnlinePayment" value="0" <?= ($app_result['isOnlinePayment'] == '0') ? 'checked' : '' ?>>
                                    Disabled
                                    <input type="radio" name="isOnlinePayment" class="isOnlinePayment" id="isOnlinePayment" value="1" <?= ($app_result['isOnlinePayment'] == 1) ? 'checked' : '' ?>>Enabled
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="radio" name="isCOD" class="isCOD" value="1" <?= ($app_result['isCOD'] == '1') ? 'checked' : '' ?>>Enabled
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="radio" name="whatsapp_share" class="whatsappFlag" value="1" <?= ($app_result['whatsappFlag'] == '1') ? 'checked' : '' ?>>Enabled
                                </div>
                            </div>
                        </div>
                    <?php } ?>
