    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/index'; ?>">Home</a> / Time Slot</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading"> Time Slot</header>
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'time_slot/time_slot_profile'; ?>" class="btn btn-primary">Add Time Slot</a>
                                    <a href="#" id="delete_user" class="btn btn-danger">Delete Time Slot</a>
                                </div>
                                <table class="display table table-bordered table-striped dataTable" id="example"
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            ...
                                            style="width: 200px;">Start Time
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            rowspan="1" colspan="1"
                                            aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 200px;">End Time
                                        </th>
                                         <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            rowspan="1" colspan="1"
                                            aria-label="Rendering engine: activate to sort column ascending"
                                  ...
                                  <!--   <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    <?php foreach ($time_slot_result as $result){ ?>
                                        <tr class="gradeX odd">
                                            ...
                                            <td class="hidden-phone"><?php echo $result->start_time; ?></td>
                                            <td class="hidden-phone"><?php echo $result->end_time; ?></td>
                                            <td>
                                                <a href="<?php echo base_url() . 'time_slot/time_slot_profile?id='.$this->utility->encode($result->id); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
    ...
    function single_delete(value) {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                var id = value;
                $.ajax({
                    url: '<?php echo base_url().'time_slot/single_delete_time_slot'; ?>' ,
                    data: {
                        id: id
                    },
                    success: function (data) {
                        ...
                        if (data.status == 1) {
                            bootbox.alert("Time Slot has been deleted successfully.", function() {
                    ...
                    error: function () {
                        alert('Failed to delete selected time_slot.');
                    }
                });
            }
            else
    ...
    $('#delete_user').click(function() {
        ...
        bootbox.confirm("Are you sure you want to delete ?" , function (confirmed) {
            if (confirmed == true) {
                ...
                $.ajax({
                    url: '<?php echo base_url().'time_slot/multi_delete_time_slot'; ?>',
                    data: { ids: ids.toString() },
                    success: function(data) {
                        if(data.status == 1) {

                            bootbox.alert("Time Slot(s) has been deleted successfully.", function() {
                                window.location.reload(true);
                            });
                        }
                        else {
