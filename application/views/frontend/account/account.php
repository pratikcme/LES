        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= ($action_name == 'my_account' || $action_name == '') ? 'active' : '' ?> "
                        id="v-pills-myaccount-tab" data-toggle="pill" href="#v-pills-myaccount" role="tab"
                        aria-controls="v-pills-myaccount"
                        aria-selected="<?= ($action_name == 'my_account' || $action_name == '') ? 'true' : 'false' ?> ">
                        <span><i class="fas fa-user"></i></span> <?= $this->lang->line('My account') ?>
                    </a>
                    <a class="nav-link <?= ($action_name == 'order') ? 'active' : '' ?>" id="v-pills-orders-tab"
                        data-toggle="pill" href="#v-pills-orders" role="tab" aria-controls="v-pills-orders"
                        aria-selected="<?= ($action_name == 'order') ? 'true' : 'false' ?>">
                        <span><i class="fas fa-shopping-bag"></i></span><?= $this->lang->line('My order') ?></a>
                    <a class="nav-link <?= ($action_name == 'wishlist') ? 'active' : '' ?> " id="v-pills-whislist-tab"
                        data-toggle="pill" href="#v-pills-whislist" role="tab" aria-controls="v-pills-whislist"
                        aria-selected="<?= ($action_name == 'wishlist') ? 'true' : 'false' ?>"> <span><i
                                class="fas fa-heart"></i></span><?= $this->lang->line('My Wishlist') ?></a>
                    <a class="nav-link <?= ($action_name == 'my_address') ? 'active' : '' ?> " id="v-pills-address-tab"
                        data-toggle="pill" href="#v-pills-address" role="tab" aria-controls="v-pills-address"
                        aria-selected="<?= ($action_name == 'my_address') ? 'true' : 'Your Wishlist' ?>"><span><i
                                class="fas fa-address-book"></i></span><?= $this->lang->line('My address') ?></a>
                    <?php if (!empty($getVedorDetails) && $getVedorDetails[0]->login_type == '0') { ?>
                    <a class="nav-link <?= ($action_name == 'change') ? 'active' : '' ?> " id="v-pills-change-tab"
                        data-toggle="pill" href="#v-pills-change" role="tab" aria-controls="v-pills-change"
                        aria-selected="<?= ($action_name == 'change') ? 'true' : 'false' ?>"><span><i
                                class="fas fa-lock"></i></span><?= $this->lang->line('Change Password') ?></a>
                    <?php } ?>
                    <a style="display: none;" class="nav-link <?= ($action_name == 'faq') ? 'active' : '' ?> "
                        id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab"
                        aria-controls="v-pills-settings"
                        aria-selected="<?= ($action_name == 'faq') ? 'true' : 'false' ?>"><span><i
                                class="fas fa-info-circle"></i></span>FAQ</a>
                    <a class="nav-link" role="tab" id="logout"><span><i
                                class="fas fa-power-off"></i></span><?= $this->lang->line('logout') ?></a>

                    <a class="nav-link" role="tab" id="delete_account"><span><i
                                class="fas fa-minus"></i></span><?= $this->lang->line('Delete Account') ?></a>
                </div>
            </div>
            <div class="col-lg-9 col-md-8">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade <?= ($action_name == 'my_account' || $action_name == '') ? 'active show' : '' ?> "
                        id="v-pills-myaccount" role="tabpanel" aria-labelledby="v-pills-myaccount-tab">
                        ...
                        <h1>Account Detailssss</h1>
                            ...
                            <div class="your-order-header address-header" id="address-header">
                                <h4><span><i class="fas fa-user"></i></span><?= $this->lang->line('Account Details') ?>
                                </h4>

                            </div>
                            <form id='ChangePass' action="<?= base_url() . 'users_account/users/account' ?>"
                                method="post" class="account-form" enctype="multipart/form-data">
                                <input type="hidden" name="hidden_image" value="<?= $userDetails[0]->profileimage ?>">
                                <div class="text-center">
                                    <div class="group-image">
                                        <div class="circle">
                                            <img class="profile-pic"
                                                src="<?= ($userDetails[0]->profileimage != '') ? base_url() . 'public/images/' . $this->folder . 'user_profile/' . $userDetails[0]->profileimage : 'https://t3.ftcdn.net/jpg/03/46/83/96/360_F_346839683_6nAPzbhpSkIpb8pmAwufkC7c5eD7wYws.jpg' ?>">
                                        </div>
                                        <div class="p-image">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" name="user_gst_number"
                                                placeholder="<?= $this->lang->line('Gst number') ?>"
                                                value="<?= $userDetails[0]->user_gst_number ?>" readonly
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" name="phone"
                                                placeholder="<?= $this->lang->line('Mobile Number*') ?>" class="phone"
                                                id="phone" value="<?= $userDetails[0]->phone ?>">
                                        </div>
                                    ...
                                    <div class="col-md-12 mt-4 ">
                                        <button type="submit" id="btnAccSubmit"
                                            class="btn"><?= $this->lang->line('Update') ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'order') ? 'active show' : '' ?>" id="v-pills-orders"
                        role="tabpanel" aria-labelledby="v-pills-orders-tab">
                        <?php if (empty($order)) { ?>
                        <?php if ($this->session->userdata('branch_id') == '') { ?>
                        <div class='no-orderss' style="position: absolute;top: 70%;left: 23%;">
                            <h6 style="font-size: 25px;">Please Select Branch To See Your Wishlist!</h6>
                        </div>
                        <?php } else { ?>
                        <div class='no-orderss' style="position: absolute;top: 70%;left: 32%;">
                            <h6 style="font-size: 25px;"><?= $this->lang->line('No Orders Available') ?></h6>
                        </div>
                        <?php } ?>
                        <?php } ?>
                        ...
                        <div class="your-order-wrapper bg-white">
                            <div class="your-order-header">
                                <div>
                                    ...
                                    <h5 class="your-order-header_address"><?= $value->vendorName ?>,
                                        <span><?= $value->vendorAddress ?></span>
                                    </h5>
                                    <h6 class="your-order-header_number"><span> order No. </span>
                                        <?= str_replace('Order', '', $value->order_no); ?></h6>
                                </div>
                                <p class="details"><?= $this->lang->line('Details') ?> <span><i
                            ...
                            <ul>
                                ...
                                <li>
                                    <a
                                        ...
                                        <div class="your-order-img-wrap">
                                            <?php if (isset($v->food_type) && $v->food_type == '1') { ?>
                                            <img src="<?= base_url() . 'public/frontend/assets/images/vage-icon.svg' ?>"
                                                alt="veg-icon" class="veg-icon">
                                            <?php } else if (isset($v->food_type) && $v->food_type == '2') { ?>
                                            <img src="<?= base_url() . 'public/frontend/assets/images/non-vage-icon.svg' ?>"
                                                alt="nonveg-icon" class="nonveg-icon">
                                            <?php } ?>
                                            <img
                                                src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $v->product_image ?>">
                                        </div>
                                    </a>
                                    <a
                                        href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($v->product_id) . '/' . $this->utility->safe_b64encode($v->product_weight_id) ?>">
                                        <div class="your-order-detail-wrap">
                                            ...
                                            <p> <?= $v->quantity ?> X <span>
                                                    <!-- <i class="fas fa-rupee-sign"> --><?= $this->siteCurrency ?></i>
                                                </span> <?= $v->discount_price ?> <del
                                                    style="margin-left: 10px;color: #999; display :<?= ($v->actual_price == $v->discount_price) ? 'none' : '' ?>">
                                                    <i class="fas fa-rupee-sign"></i><?= $v->actual_price ?></del> </p>
                                            <p style="color:#999">
                                                <?= $v->weight_number . ' ' . $v->weight_name . ' - ' . $v->package ?>
                                            </p>
                                        </div>
                                    </a>
                                </li>
                                    ...
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                    ...
                                                    <?= $this->siteCurrency ?></i>
                                                </span> <?= number_format((float)$value->payable_amount, 2, '.', '') ?>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                ...
                                                <?= number_format((float)$order[$key]->sub_total + $order[$key]->total_saving, 2, '.', '') ?>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                    ...
                                                    <?= $this->siteCurrency ?>
                                                </span><?= number_format((float)$value->shopping_amount_based_discount, 2, '.', '') ?>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="total-wrap">
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            <span class="seperator">:</span>
                                            <p> - <span>
                                                    <!-- <i class="fas fa-rupee-sign"></i> --><?= $this->siteCurrency ?>
                                                </span> <?= $value->total_saving ?></p>
                                        </div>
                                    </div>
                                </li>
                                <li class="total-wrap">
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                ...
                                                <?= number_format((float)$value->sub_total - $value->TotalGstAmount, 2, '.', '') ?>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="total-wrap">
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                    <!-- <i class="fas fa-rupee-sign"></i> --><?= $this->siteCurrency ?>
                                                </span> <?= $order[$key]->TotalGstAmount ?></p>
                                        </div>
                                    </div>
                                </li>
                                <li class="total-wrap">
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                    <!-- <i class="fas fa-rupee-sign"></i> -->
                                                    <?= $this->siteCurrency ?>
                                                </span> <?= number_format($value->delivery_charge, 2, '.', '') ?></p>
                                            <?php } else { ?>
                                            <p>Free</p>
                                            <?php } ?>
                                        </div>
                                    ...
                                    <div class="total-count">
                                        ...
                                        <div class="price-seperator">
                                            ...
                                            <p><span>
                                                    <!-- <i class="fas fa-rupee-sign"></i> --> -
                                                    <?= $this->siteCurrency ?>
                                                </span><?= $value->promocode_discount ?></p>
                                        </div>
                                    </div>
                                </li>
                                ...
                                <li class="total-wrap">
                                    <div class="total-count">
                                        <h6><span><i
                                                    class="fas fa-mobile"></i></span><?= ($value->isSelfPickup == '1') ? $this->lang->line('self pickup otp') : "OTP" ?>
                                        </h6>
                                        <div class="price-seperator">
                                            <span class="seperator">:</span>
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'wishlist') ? 'active show' : '' ?>"
                        ...
                        <?php } else { ?>
                        <div class='no-orderss' style="position: absolute;top: 70%;left: 32%;">
                            <h6 style="font-size: 25px;"><?= $this->lang->line('No Item Available') ?></h6>
                        </div>
                        <?php } ?>
                        <?php } ?>
                        <div class="wihslist-wrapper bg-white ">
                            <div class="your-order-header">
                                <h4><span><i class="fas fa-heart"></i></span><?= $this->lang->line('Your Wishlist') ?>
                                </h4>
                            </div>
                            <ul>
                                ...
                                <li>
                                    <div class="img-con-cart">
                                        ...
                                        <a
                                            ...
                                            <div class="your-order-detail-wrap">
                                                <h6><?= $value->name ?></h6>
                                                <p>1 X <span><i class="fas fa-rupee-sign"></i></span>
                                        ...
                                        <div class="feature-bottom-wrap ">
                                            ...
                                            <div class="new_add_to_cart <?= $d_none ?>">
                                                ...
                                                <button class="btn addcartbutton"
                                                    ...
                                                    data-varient_id="<?= $this->utility->safe_b64encode($value->product_weight_id) ?>"><?= $this->lang->line('add to cart') ?></button>
                                                <?php } ?>
                                            </div>
                                            <div class="quantity-wrap <?= $d_show ?>">
                                                <button class="dec cart-qty-minus"
                                                    data-product_weight_id="<?= $value->product_weight_id ?>"><span
                                                ...
                                                <button class="inc cart-qty-plus"
                                                    data-product_weight_id="<?= $value->product_weight_id ?>"><span><i
                                                            class="fa fa-plus"></i></span></button>
                                            </div>
                                        </div>
                                        <span class="delete-item removeWishlistItem"
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'my_address') ? 'active show' : '' ?>"
                        id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
                        <div class="wihslist-wrapper  address-wrapper bg-white new-address-wrap" id="new-address-wrap">
                            <div class="your-order-header address-header new-add-header">
                                <h4><span><i
                                            class="fas fa-address-book"></i></span><?= $this->lang->line('Add New Address') ?>
                                </h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" class="mob_no" name="phone"
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" id="departure_address"
                                                onFocus="initAutocomplete('departure_address')" class="form-control"
                                                placeholder="<?= $this->lang->line('Enter Location') ?>" name="location"
                                                maxlength="255" value="<?php echo set_value('location'); ?>"
                                                autocomplete="off">
                                            <?php echo form_error('location'); ?>
                                        </div>
                                        <label for="departure_address" class="error"></label>
                                        <input type="hidden" id="departure_latitude" name="latitude"
                                            placeholder="Latitude" value="<?php echo set_value('latitude'); ?>" />
                                        <input type="hidden" id="departure_longitude" name="longitude"
                                            placeholder="Longitude" value="<?php echo set_value('longitude'); ?>" />
                                    </div>

                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            <span><i class="fas fa-landmark"></i></span>
                                            <input type="text" class="landmark" name="landmark"
                                                placeholder="<?= $this->lang->line('Landmark') ?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            <span><i class="fas fa-globe-americas"></i></span> <input type="text"
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" name="country" class="form-control"
                                                placeholder="<?= $this->lang->line('country') ?>" id="country">
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-wrapper add-text">
                                            ...
                                            <textarea name="address"
                                                placeholder="<?= $this->lang->line('Enter Address') ?>" id="address"
                                                class="form-control add-textarea" autocomplete="off"></textarea>
                                        </div>
                        ...
                        <div class="wihslist-wrapper  address-wrapper bg-white">
                            <div class="your-order-header address-header" id="address-header">
                                <h4><span><i
                                            class="fas fa-address-book"></i></span><?= $this->lang->line('My address') ?>
                                </h4>
                                <button class="btn add-new-address add_form_action"><span style="margin-right: 5px;"> <i
                                            class="fas fa-plus"></i> </span>
                                    <?= $this->lang->line('Add New Address') ?></button>
                            </div>
                            <ul>
                                ...
                                <li>
                                    <div class="address-list">
                                        ...
                                        <div class="address-operation">
                                            <div class="address-chk-box <?= $status ?>"
                                                data-id='<?= $this->utility->safe_b64encode($value->id) ?>'>
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'faq') ? 'active show' : '' ?>" id="v-pills-settings"
                        role="tabpanel" aria-labelledby="v-pills-whislist-tab">
                        <div class="wihslist-wrapper bg-white faq-accordion-tab">
                            ...
                            <button class="accordion mt-4 <?= ($key == '0') ? 'active' : '' ?>">
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'change') ? 'active show' : '' ?> "
                        id="v-pills-change" role="tabpanel" aria-labelledby="v-pills-change-tab">
                        <div class="wihslist-wrapper address-wrapper bg-white">
                            <div class="your-order-header address-header" id="address-header">
                                <h4><span><i class="fas fa-lock"></i></span><?= $this->lang->line('Change Password') ?>
                                </h4>
                            </div>
                            <form id='ChangeUserPass' action="<?= base_url() . 'users_account/users/update_password' ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="password" name="old_pass"
                                                placeholder="<?= $this->lang->line('current password') ?>" required="">
                                        </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="input-wrapper">
                                            <span><i class="fas fa-lock"></i></span>
                                            <input type="password" name="new_pass" id="password_new"
                                    ...
                                    <div class="col-md-12 mt-4 ">
                                        <button type="submit" id="btnChangeUserPass"
                                            class="btn"><?= $this->lang->line('Change Password') ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
