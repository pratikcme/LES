        ...
        <div class="row">
            <div class="col-lg-3 col-md-4">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link <?= ($action_name == 'my_account' || $action_name == '') ? 'active' : '' ?> " id="v-pills-myaccount-tab" data-toggle="pill" href="#v-pills-myaccount" role="tab" aria-controls="v-pills-myaccount" aria-selected="<?= ($action_name == 'my_account' || $action_name == '') ? 'true' : 'false' ?> ">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade <?= ($action_name == 'my_account' || $action_name == '') ? 'active show' : '' ?> " id="v-pills-myaccount" role="tabpanel" aria-labelledby="v-pills-myaccount-tab">
                        ...
                        ?>
                            ...
                            <div class="your-order-wrapper bg-white">
                                ...
                                <ul>
                                            ...
                                            <a href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($v->product_id) . '/' . $this->utility->safe_b64encode($v->product_weight_id) ?>">
                                                <div class="your-order-detail-wrap">
                                                    ...
                                                    <p> <?= $v->quantity ?> X <span>
                                                        ...
                                                        </span> <?= $v->discount_price ?> <del style="margin-left: 10px;color: #999; display :<?= ($v->actual_price == $v->discount_price) ? 'none' : '' ?>">
                                    ...
                                    <li class="total-wrap">
                                        <div class="total-count">
                                            <h6><span><i class="fas fa-mobile"></i></span><?= ($value->isSelfPickup == '1') ? $this->lang->line('self pickup otp') : "OTP" ?>
                                            </h6>
                                            <div class="price-seperator">
                                                <span class="seperator">:</span>
                    ...
                    <div class="tab-pane fade <?= ($action_name == 'my_address') ? 'active show' : '' ?>" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-address-tab">
                        <div class="wihslist-wrapper  address-wrapper bg-white new-address-wrap" id="new-address-wrap">
                            <div class="your-order-header address-header new-add-header">
                                <h4><span><i class="fas fa-address-book"></i></span><?= $this->lang->line('Add New Address') ?>
                                </h4>
                        ...
                        <div class="wihslist-wrapper  address-wrapper bg-white">
                            <div class="your-order-header address-header" id="address-header">
                                <h4><span><i class="fas fa-address-book"></i></span><?= $this->lang->line('My address') ?>
                                </h4>
                                <button class="btn add-new-address add_form_action"><span style="margin-right: 5px;"> <i class="fas fa-plus"></i> </span>
