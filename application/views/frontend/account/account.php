        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8">
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade <?= ($action_name == 'my_account') ? 'active show' : '' ?> "
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 mt-4 ">
                                        <button type="submit" id="btnAccSubmit"
                                            class="btn"><?= $this->lang->line('Save') ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
