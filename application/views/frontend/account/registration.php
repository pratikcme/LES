...
<section class="p-100 bg-cream">
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-12">
                <form id="RegisterForm" method="post" class="login-form register-form"
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="phone" class="mob_no"
                            placeholder="<?=$this->lang->line('Mobile Number*')?>" required>
                    </div>
                    <label for="phone" class="error"></label>

                    <div class="input-wrapper">
                        <span><i class="fas fa-envelope"></i></span>
                        <input type="text" name="email" placeholder="<?=$this->lang->line('Email*')?>" readonly
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="password" placeholder="<?=$this->lang->line('password*')?>"
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="confirm_password"
                            placeholder="<?=$this->lang->line('Confirm password*')?>" id="confirm_password" required>
                        <span id="ceye"><i class="far fa-eye-slash"></i></span>
                    </div>
                    <label for="confirm_password" class="error"></label>
                    <label class="main">By creating an account, you agree to our <a
                            href="<?=base_url().'terms_condition'?>"> Terms Of Conditions </a> and <a
                            href="<?=base_url().'privacy_policy'?>"> privacy policy.</a>
                    ...
                    <div class="social-btns">
                        <a href="<?=base_url().'login/fb_login'?>" class="btn facebook-btn"><span><i
                                    class="fab fa-facebook-f"></i></span><?=$this->lang->line('continue with facebook')?></a>
                        <a href="<?=$googleUrl?>" class="btn google-btn"><span><i
                                    class="fab fa-google-plus-g"></i></span><?=$this->lang->line('continue with google')?></a>
                    </div>

                    <p><?=$this->lang->line('Already have an account ?')?><a href="<?=base_url().'login'?>">
                            <?=$this->lang->line('login')?> </a></p>
                </form>
            </div>
