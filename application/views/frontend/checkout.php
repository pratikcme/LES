        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                <div class="cart-table-wrapper billing-wrapper">
                    <div class="billing-header">
                        ...
                        <div class="selfpickup-wrap">
                            ...
                            <div class="address-chk-box dn-btn">
                                <label> Self Pickup
                                    <input type="checkbox" id="isSelfPickup" class="default_check"
                            ...
                            <div class="address-chk-box dn-btn">
                                <label> Use GST Number
                                    <input type="checkbox" id="user_gst_number" class="default_check"
                    ...
                    <button
                        class="billing-btns active"><?= (isset($_SESSION['isSelfPickup']) && $_SESSION['isSelfPickup'] == '1') ?  "Pickup Address" : "Delivery Address" ?></button>
                                    ...
                                    <div class="col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" id="departure_address"
                                                ...
                                                placeholder="Enter Location" name="location" maxlength="255"
                                                value="<?php echo set_value('location'); ?>" autocomplete="off">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            <span><i class="fas fa-globe-americas"></i></span> <input type="text"
                                                name="city" id="city" placeholder="city" autocomplete="off">
                                        </div>
                                 ...
                                 <span class="select-down-arrow"><i class="fas fa-chevron-down"></i></span> -->
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" name="pincode" class=" pincode" id="pincode"
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input-wrapper add-text">
                                            ...
                                            <textarea name="address" placeholder="Enter Address" id="address"
                                                class=" add-textarea" autocomplete="off"></textarea>
                                        </div>
                                ...
                                <li>
                                    <div class="address-list">
                                        ...
                                        <div class="address-operation">
                                            <div class="address-chk-box <?= ($value->status != '1') ? 'is_default' : '' ?>"
                                                data-id='<?= $this->utility->safe_b64encode($value->id) ?>'>
                                                <label> Defualt
                                                    <input type="checkbox" value="<?= $key ?>"
                                                        class="default_check chek"
                ...
                <button
                    class="billing-btns active"><?= (isset($_SESSION['isSelfPickup']) && $_SESSION['isSelfPickup'] == '1') ?  "Pickup " : "Delivery " ?>
                    Time & Date</button>
                <?php } ?>
                <div class="panel">
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="radio-container"><?= $value->start_time ?> -
                                                ...
                                                <input type="radio"
                                                    ...
                                                    class="time_slot_checked" name="time_slot"
                                                    value="<?= $value->id ?>">
                           ...
                           <span class="checkmark"></span>
                            ...
                            <div class="option-1">
                                <label class="radio-container mb-0">Online Pay
                                    <input id="credit" class="pay-chk" type="radio" name="radio"
                            ...
                            <div class="option-1">
                                <label class="radio-container mb-0">Cash On Delivery
                                    <input class="pay-chk" type="radio"
                                        <?= ($isCOD == '1' && $isOnlinePayment == '0') ? 'checked' : '' ?> name="radio"
                                        value="0">
                                    <span class="checkmark"></span>
                                </label>
                            </div>
                    ...
                    <ul>
                        <li class="total-wrap">
                            <div class="total-count">
                                <h6>Sub
                                    total<br>(<?= ($isShow[0]->display_price_with_gst == '1') ? "Exclude" : "Inc." ?>
                                    Tax)</h6>
                        ...
                        <li class="total-wrap">
                            <div class="total-count">
                                ...
                                <div class="price-seperator">
                                    <span class="seperator">:</span>
                                    <p><span><?= $this->siteCurrency ?></span> <span id=""><?= $TotalGstAmount ?></span>
                                    </p>
                                </div>
                            </div>
                        </li>
                        ...
                        <li class="saving">
                            <p>You will save <span
                                    id='totalSaving'><?= $this->siteCurrency . ' ' . totalSaving() ?></span> on this
                                order</p>
                        </li>
                        <?php } ?>
                        ...
                        <li class="saving">
                            <h6> <img src="<?= base_url() . 'public/frontend/' ?>assets/images/shield.png"> 100% Genuine
                                Products</h6>
                        </li>
                        <li class="saving">
                            <h6> <img src="<?= base_url() . 'public/frontend/' ?>assets/images/secure-pay.png">Secure
                                Payments</h6>
                        </li>
