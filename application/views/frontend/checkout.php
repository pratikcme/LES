        ...
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <?php if ($isDeliveryTimeDate == '1' || isset($_SESSION['isSelfPickup']) && $_SESSION['isSelfPickup'] == '1') { ?>
                    <button class="billing-btns active"><?= (isset($_SESSION['isSelfPickup']) && $_SESSION['isSelfPickup'] == '1') ?  "Pickup " : "Delivery " ?>
                        Time & Date</button>
                <?php } ?>
                <div class="panel">
                ...
                <div class="cart-total-innerbox your-order-wrapper order-summary-box ">
                    ...
                    <ul>
                        ...
                        <?php if (totalSaving() > '0.00') { ?>
                            <li class="saving">
                                <p>You will save <span id='totalSaving'><?= $this->siteCurrency . ' ' . totalSaving() ?></span> on this
                                    order</p>
                            </li>
                        <?php } ?>
