                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" class="fname" name="fname"
                                                placeholder="<?=$this->lang->line('Full Name')?>" autocomplete="off">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            ...
                                            <input type="text" class="landmark" name="landmark"
                                                placeholder="<?=$this->lang->line('Landmark')?>" autocomplete="off">
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="input-wrapper">
                                            <span><i class="fas fa-globe-americas"></i></span> <input type="text"
                                                name="city" id="city" placeholder="<?=$this->lang->line('city')?>"
                                                autocomplete="off">
                                        </div>
                                        ...
                                        <div class="col-lg-6 col-sm-6">
                                            <label class="radio-container"><?=$value->start_time?> -
                                                ...
                                                <input type="radio"
                                                    ...
                                                    class="time_slot_checked" name="time_slot" value="<?=$value->id?>">
                    ...
                    <ul>
                        ...
                        <li class="saving">
                            ...
                            <button id="checkPromocode" class="btn btn-primary"
                                type="button"><?=$this->lang->line('Apply')?></button>
                        </li>
                        <?php } ?>
                        <li class="saving">
                        ...
                        <li class="saving">
                            <h6> <img
                                    src="<?=base_url().'public/frontend/'?>assets/images/secure-pay.png"><?=$this->lang->line('Secure Payments')?>
                            </h6>
                        </li>
...
<div class="modal fade otp-popup" id="" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
