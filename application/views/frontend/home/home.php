          ...
          <div class="item">
            <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>">
              <div class="category-wrapper">
                <div class="category-img"><img class="lazy" data-src="<?= base_url() . 'public/images/' . $this->folder . 'category/' . $value->image ?>">
                </div>
          ...
          <div class="slider_box categoty_shukan">
            <?php foreach ($category as $key => $value) : ?>
              <div class="shukan_product">
                <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>">
                  <div class="category-wrapper">
                    <div class="category-img"> <img class="lazy" data-src="<?= base_url() . 'public/images/' . $folder . $value->image ?>">
                    </div>
                    <div class="category-name">
                      <h6><?= $value->name ?></h6>
                    </div>
          ...
          <div class="item">
            <div class="product-wrapper">
              ...
              <a href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->id) . '/' . $this->utility->safe_b64encode($value->pw_id) ?>">
                <div class="feat-img"> <img class="lazy" data-src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>">
                </div>
              </a>
