...
<div id="carousel" class="carousel slide hero-slides" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item <?= ($key == 0) ? "active" : "" ?> <?= $calss[$key] ?>"
            data-id="<?= $value->web_banner_image ?>">
            <img data-src="<?php echo base_url() . 'public/images/' . $this->folder . 'web_banners/' . $value->web_banner_image ?>"
                class="banner-image lazy" alt="">
                    ...
                    <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                        <div class="caption animated fadeIn">
                            ...
                            <a class="btn animated fadeInUp"
                                href="<?= base_url() . 'products' ?>"><?= $this->lang->line('Shop Now') ?></a>
                        </div>
                        <?php } else if ($value->type == '2') { ?>
                        <a class="btn animated fadeInUp"
                            href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->category_id) ?>"><?= $this->lang->line('Shop Now') ?></a>
                    </div>
                    <?php } else { ?>
                    <a class="btn animated fadeInUp"
                        href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->product_id) . '/' . $this->utility->safe_b64encode($value->product_varient_id) ?>"><?= $this->lang->line('Shop Now') ?></a>
                </div>
                <?php } ?>
            </div>
        </div>
...
<section class="p-100 bg-light-blue">
    <div class="container">
        ...
        <div class="mobile-see-all"> <a href="<?= base_url() . 'products' ?>"><?= $this->lang->line('See All') ?></a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="section-title-wrapper">
            <div class="row align-items-center">
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="section-title">
                        <h1><?= $this->lang->line('SHOP BY CATEGORIES') ?></h1>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-12">
            ...
            <div class="item">
                <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>">
                    <div class="category-wrapper">
                        <div class="category-img"><img class="lazy"
                                data-src="<?= base_url() . 'public/images/' . $this->folder . 'category/' . $value->image ?>">
                        </div>
                ...
                <div class="slider_box categoty_shukan">
                    ...
                    <div class="shukan_product">
                        <a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>">
                            <div class="category-wrapper">
                                <div class="category-img"> <img class="lazy"
                                        data-src="<?= base_url() . 'public/images/' . $folder . $value->image ?>">
                                </div>
                                <div class="category-name">
                                    <h6><?= $value->name ?></h6>
                                </div>
    ...
    <div class="container">
        <div class="section-title-wrapper">
            <div class="row align-items-center">
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="section-title">
                        <h1><?= $this->lang->line('TOP FEATURED PRODUCTS') ?></h1>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="see-all-wrap"> <a
            ...
            <div class="item">
                <div class="product-wrapper">
                    ...
                    <a
                        ...
                        <div class="feat-img"> <img class="lazy"
                                data-src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>">
                        </div>
                    </a>
                    ...
                    <div class="feature-bottom-wrap ">
                        ...
                        <div class="new_add_to_cart <?= $d_none ?>">
                            <button class="btn addcartbutton"
                                ...
                                data-varient_id="<?= $this->utility->safe_b64encode($value->pw_id) ?>"><?= $this->lang->line('add to cart') ?></button>
                        </div>
                        <div class="quantity-wrap <?= $d_show ?>">
                            <button class="dec cart-qty-minus" data-product_weight_id="<?= $value->pw_id ?>"><span
                            ...
                            <input class="qty" type="text" name=""
                                ...
                                data-product_id="<?= $value->id ?>" data-weight_id="<?= $value->weight_id ?>" readonly>
          ...
          <div class="see-all-wrap"> <a href="https://mehtaenterpriseonline.com/products"><?= $this->lang->line('See All') ?></a> </div>
            ...
            ?>
                    <div class="shukan_product">
                        ...
                        <div class="product-wrapper">
                            <?php if ($value->varientQuantity == '0') { ?>
                            <div class="out-stock"><span
                                    class="out-heading"><?= $this->lang->line('out of stock') ?></span></div>
                            <?php } ?>
                            <div class="wishlist-wrapper">
                                <?php if ($value->discount_per > '0') { ?>
                                <div class="offer-wrap">
                            ...
                            <div class="feature-bottom-wrap ">
                                ...
                                <div class="quantity-wrap <?= $d_show ?>">
                                    ...
                                    <button class="inc cart-qty-plus"
                                        data-product_weight_id="<?= $value->pw_id ?>"><span><i
                                                class="fa fa-plus"></i></span></button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="container">
        <div class="section-title-wrapper">
            <div class="row align-items-center">
                <div class="col-md-8 col-sm-8 col-12">
                    <div class="section-title">
                        <h1><?= $this->lang->line('NEW PRODUCTS') ?></h1>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-12">
                    <div class="see-all-wrap"> <a
      ...
      ?>
        ...
        <div id="new_product_2"
            class="owl-carousel top-feature-slider new_product_2 <?= ($slide_cnt < 25) ? 'd-none' : '' ?> ">
