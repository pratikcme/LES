        ...
        <div class="col-md-9 col-sm-8 col-12">
            <div class="menu-bar onlyLogin">
              ...
              <option value="ar" <?php if($this->session->userdata('site_lang') == 'ar') echo 'selected="selected"'; ?>>Arabic</option>
                ...
                <div class="search-wrap">
                    <input type="text" name="search" id='search' data-search_val="" class="form-control"
            ...
            if($segment1 != '') { ?>
                <div class="search-wrap autocomplete">
                    <input type="text" name="myCountry" id='myInput' data-search_val=""
                        class="form-control search web myInput" placeholder="<?=$placeholder?>">
                    <!-- <span><i class="fas fa-search"></i></span> -->
                ...
                <div class="d-flex">
                    <div class="cart_outter_wrap">
                        <div class="cart-wrap">
                            ...
                            <span class="qnty-num" id="itemCount"
                                <?=(isset($this->cartCount) && $this->cartCount != 0 ) ? 'style="display:block"' : 'style="display:none"' ?>><?=(isset($this->cartCount)) ? $this->cartCount : '' ?></span>
                        </div>
                        <div class="cart-view-wrap <?=(!isset($this->cartCount) || $this->cartCount == 0) ? 'd-none' : '' ?>"
                            id="nav_cart_dropdown">
                            <div class="cart-view-header">
                                <h6><span class="title-cart"><i
                                            class="fas fa-shopping-basket"></i></span><?=$this->lang->line('cart')?>
                                </h6>
                    ...
                    ?>
                                    <li>
                                        ...
                                        <a
                                            ...
                                            <div class="cart-detail-wrap">
                                                ...
                                                <p><span><?=$value['quantity']?></span> X
                                                    <?=number_format((float)$product[0]->discount_price, 2, '.', '')?>
                                                </p>
                                            </div>
                                        </a>
                                    ...
                                    <li>
                                        <a
                                            ...
                                            <div class="cart-img-wrap">
                                                ...
                                                <?php } ?>
                                                <img
                                                    src="<?=base_url()?>public/images/<?=$this->folder?>product_image/<?=($value->image != '') ? $value->image : 'defualt.png' ?>">
                                            </div>
                                        </a>
                                        <a
                                            href="<?=base_url().'products/productDetails/'.$this->utility->safe_b64encode($value->product_id).'/'.$this->utility->safe_b64encode($value->product_weight_id)?>">
                                            <div class="cart-detail-wrap">
                                                <h6><?=$value->product_name?></h6>
                                                <p><span><?=$value->quantity?></span> X
                                                    <?=number_format((float)$value->discount_price, 2, '.', '')?></p>
                                            </div>
                                        </a>
                                        <a href="javascript:" class="remove_item"
                                            data-product_id="<?=$value->product_id?>"
                                ...
                                <div class="view-cart-btn-wrapper">
                                    <a href="<?=base_url().'products/cart_item'?>"
                                        class="btn"><?=$this->lang->line('view cart')?></a>
                                    <a href="<?=base_url().'checkout'?>"
                                        class="btn"><?=$this->lang->line('checkout')?></a>
                                </div>
                    ...
                    <?php if($this->session->userdata('user_id') != ''){ ?>
                    <div class="notif">
                        <div class="<?=(count($notification) > 0) ? "btn__badge" : "" ?> pulse-button" id="notify-dot">
                        </div>
                        <i class="fas fa-bell dropdown-toggle notify-dropdown"></i>
                        <ul class="dropdown notify-drop <?=(count($notification) == '0' ) ? "ishave" : "" ?>"
                            id="notification">
                    ...
                    <div class="mobile-login">
                        ...
                        <div class="user-profile">
                            <div class="user-profile-header">
                                <h6><span class="title-cart"><i
                                            class="fas fa-user-circle"></i></span><?=$this->session->userdata('user_name')?>
                                </h6>
                                <span class="closing"><i class="fas fa-times-circle"></i></span>
                            </div>
            ...
            <div class="mobile-location">
                ...
                <div class="location-wrap-2">
                    <select class="form-control vendor_nav">
                        ...
                        <?php foreach ($branch_nav as $key => $v): ?>
                        <option value="<?=$v->id?>"
                            <?=(isset($_SESSION['vendor_id']) && $v->id == $_SESSION['vendor_id']) ? 'selected' : '' ?>>
                            <?=$v->name?></option>
                        <?php endforeach ?>
                    </select>
                </div>
        ...
        <div class="col-md-12">
            ...
            if($segment1 != '' ) { ?>
                <div class="search-wrap-2">
                    <input type="text" name="search" attr-v="mob" class="form-control search myInput"
