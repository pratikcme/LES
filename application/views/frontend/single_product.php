          ...
          <div class="slider slider-for">
            ...
            if (count($product_image) > 0) {
              foreach ($product_image as $key => $value) { ?>
                <div class="main-img-wrapper xzoom-container"> <img class="slide-img demo-trigger" src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>" data-zoom="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>"> </div>
              <?php }
            } else { ?>
              <div class="main-img-wrapper xzoom-container"> <img class="slide-img demo-trigger" src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $image[0] ?>" data-zoom="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $image[0] ?>"> </div>
