            ...
            <div class="col-lg-6">
                <div class="product-slider" id="detail">
                    <div class="wishlist-wrapper" id='is_discounted'>
                        ...
                        <?php } ?>
                        <div class="wishlist-icon" style="display: ''" data-product_id="<?= $product_id ?>" data-product_weight_id="<?= $product_weight_id ?>"> <i class="far fa-heart <?= (in_array($this->utility->safe_b64decode($product_weight_id), $wish_pid)) ? "fas .fa-heart" : "" ?>"></i>
                        </div>
                    </div>
                    <div class="slider slider-for">
                        ...
                        if (count($product_image) > 0) {
                            foreach ($product_image as $key => $value) { ?>
                                <div class="main-img-wrapper xzoom-container"> <img class="slide-img demo-trigger" src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>" data-zoom="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>">
                                </div>
                            <?php }
                        } else { ?>
                            <div class="main-img-wrapper xzoom-container"> <img class="slide-img demo-trigger" src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $image[0] ?>" data-zoom="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $image[0] ?>">
                            </div>
                    ...
                    <div class="slider slider-nav">
                        <?php foreach ($product_image as $key => $value) { ?>
                            <div class="thumnail"> <img src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image ?>">
                            </div>
                        <?php } ?>
                    </div>
                </div>
                            ...
                            <?php if ($isAvailable != '0') { ?>
                                <div class="order-btn ">
                                    <a href="javascript:" class="<?= $d_none ?>">
                                        <button class="btn " id="addtocart"><span><i class="fas fa-shopping-basket"></i></span>
                    ...
                    <div class="item">
                        <div class="product-wrapper">
                            ...
                            <a href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->id) . '/' . $this->utility->safe_b64encode($value->pw_id) ?>">
                                <div class="feat-img"> <img src="<?= base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->product_image ?>">
                                </div>
                            </a>
                            <div class="feature-detail">
                                <div class="card-icon">
                            ...
                            <div class="feature-bottom-wrap ">
                                ...
                                <div class="new_add_to_cart <?= $d_none ?>">
                                    <button class="btn addcartbutton" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->pw_id) ?>">Add To
                                        Cart</button>
                                </div>
                                <div class="quantity-wrap <?= $d_show ?>">
