          ...
          <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
              <div class="input-wrapper">
                ...
                <input type="text" name="fname" placeholder="<?=$this->lang->line('First Name')?>" value="<?=($this->session->userdata('user_name') != '' ) ? $this->session->userdata('user_name') : '' ?>" <?=($this->session->userdata('user_name') != '' ) ?'readonly':'';?> >
              </div>
            ...
            <div class="col-md-12">
              <div class="input-wrapper">
                ...
                <input type="text" name="email" placeholder="<?=$this->lang->line('Email')?>" value="<?=($this->session->userdata('user_email') != '' ) ? $this->session->userdata('user_email') : '' ?>" <?=($this->session->userdata('user_email') != '' ) ?'readonly':'';?> >
              </div>
            ...
            <div class="col-md-12">
              <div class="input-wrapper">
                ...
                <input type="text" name="mobile_no" placeholder="<?=$this->lang->line('Phone')?>" value="<?=($this->session->userdata('user_phone') != '' ) ? $this->session->userdata('user_phone') : '' ?>" <?=($this->session->userdata('user_phone') != '' ) ?'readonly':'';?> >
              </div>
            ...
            <div class="col-md-12">
              <div class="input-wrapper message">
                ...
                <textarea class=" " name="message" placeholder="<?=$this->lang->line('Message')?>"></textarea>
              </div>
              <label for="message" class="error"><?=form_error('message')?></label>
            </div>
            <div class="col-md-12">
            <button type="submit" class="btn" name="submit" id="btnSubmit"><?=$this->lang->line('send')?></button>
            </div>
          </div>
        </form>
      </div>
