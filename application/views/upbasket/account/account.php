...
.pac-container {
 ...
 <section class="my-account-section section">
     ...
     <img src="<?= $this->theme_base_url ?>/assets/images/checkout-bottom-right-img.svg" alt=""
         class="checkout-bottom-right-img">
     <div class="container">
                 ...
                 <ul class="nav nav-pills" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                         <a class="nav-link dashboard-tabs certificates-active-img <?= ($action_name == 'change') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-7" aria-selected="true"
                             role="tab"><?= $this->lang->line('Change Password') ?></a>
                     </li>
                     <li class="nav-item">
                 ...
                 <div class="tab-content account-details-content">
                                     ...
                                     <div class="col-xxl-6 col-md-6">
                                         <div class="mb-3">
                                             ...
                                             <input type="text" class="form-control" name="fname"
                                                 ...
                                                 value="<?= $userDetails[0]->fname ?>" id="fname"
                                     ...
                                     <div class="col-xxl-12">
                                         <div class="mb-3">
                                             ...
                                             <input type="email" class="form-control" id="email" name="email"
                                                 ...
                                                 aria-describedby="Enter Your E-mail">
                                         </div>
                                     </div>
                                     <div class="col-xxl-12">
                                         <div class="mb-3">
                                     ...
                                     <div id="subtab-2" class="container tab-pane fade">
                                         ...
                                         <div class="main-accordion">
                                             ...
                                             <div class="accordion-content">
                                                 ...
                                                 <button type="button" class="cancel-btn cncOrder"
                                                     data-href="<?= base_url() . 'orders/cancle_order/' . $this->utility->safe_b64encode($value->id) ?>"><?= $this->lang->line('Cancel Order') ?></button>
                                             </div>
                                         </div>
                                         <?php } ?>
                                     </div>
                     ...
                     <div id="tab-4"
                             ...
                             <div class="address-wrapper">
                                 <div class="ship-check text-end">
                                     <div class="form-check">
                                         <input class="from_account form-check-input <?= $status ?>"
                                             id="<?= 'add' . $key ?>"
                         ...
                         <div class="adrress-btn">
                             <a href="" class="signin-btn-green cancel-btn" data-bs-toggle="modal"
                                 data-bs-target="#addres-popup">Add New Address</a>
                         </div>
                     </div>
                                     ...
                                     <div class="col-lg-6">
                                         <div class="mb-3">
                                             ...
                                             <input type="password" class="form-control" name="new_pass"
                                                 id="password_new" autocomplete="off"
 ...
 <!-- --------address-popup---- -->
 <!-- Modal -->
 <div class="modal fade address-popup" id="addres-popup" tabindex="-1" aria-labelledby="addres-popup"
     aria-hidden="true">
             ...
             <div class="modal-body">
                 <div class="accordion-content-3">
                     ...
                     <form method="post" id="RegisterForm"
                         ...
                         <div class="row">
                             <div class="col-lg-12">
                                 <label for="fnameModal"
                                     class="form-label"><?= $this->lang->line('Full Name') ?><span>*</span></label>
                                 <input type="text" name="fname" class="form-control fname" id="fnameModal"
                             ...
                             <div class="col-lg-6">
                                 <div class="select-box">
                                     ...
                                     <input type="text" name="city" class="form-control" id="city"
                                         aria-describedby="add" placeholder="<?= $this->lang->line('city') ?>"
                                         autocomplete="off">
                                 </div>
                             </div>
                             ...
                             <div class="col-lg-6">
                                 <div class="select-box">
                                     ...
                                     <input type="text" name="state" class="form-control" id="state"
                                         aria-describedby="add" placeholder="<?= $this->lang->line('State') ?>"
                                         autocomplete="off">
                                 </div>
                             </div>
