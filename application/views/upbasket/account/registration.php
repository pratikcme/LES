                        ...
                        <div class="login-deatils-wrapper signin-deatils-wrapper">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="password" name="password"
                                    placeholder="<?= $this->lang->line('password*') ?>" id="password" autocomplete=off>
                            </div>
                            <div class="mb-3">
                                <label for="exampleInputPassword1" class="form-label">Confirm
                                    Password<span>*</span></label>
                                <input type="password" name="confirm_password"
                                    placeholder="<?= $this->lang->line('Confirm password*') ?>" id="confirm_password">
                            </div>

                            <div class="form-check">
                                <input class="form-check-input" type="checkbox" value="" name="term_policy"
                                    id="flexCheckDefault">
                            ...
                            <button type="submit"
                                class="sign-in-btn signin-btn-green"><?= $this->lang->line('Sign up') ?></button>
