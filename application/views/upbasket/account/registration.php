                        ...
                        <div class="login-deatils-wrapper signin-deatils-wrapper">
                            ...
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="flexCheckDefault">
                                    By creating an account, you agree to our <a href="#">Terms Of Conditions</a> and <a
                            ...
                            <div class="log-in-btn">
                                <a href="<?=$googleUrl?>" class="google-btn"><span><i
                                            class="fa-brands fa-google"></i></span>Login with Google</a>
                                <a href="<?=base_url().'login/fb_login'?>" class="facebook-btn"><span><i
                                            class="fa-brands fa-facebook"></i></span>Login with Facebook</a>
                            </div>
