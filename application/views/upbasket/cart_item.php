...
<section class="shop-cart-seciton">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-8 col-xl-8 col-lg-8 col-md-12 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0"
                data-wow-offset="0">
            ...
            ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="cart-Quantity-count">
                                        <div class="quantity-counter">
                                            <button id="counter-decrement" class="decrement  cart-qty-minus_c"
                                                data-product_weight_id="<?= $value['product_weight_id'] ?>">-</button>
                                            <input id="counter-value" class="value qty quantity-counter" type="text"
                                                class="qty" type="text" value="<?= $value['quantity'] ?>"
                                                data-product_id="<?= $value['product_id'] ?>"
                                                data-weight_id="<?= $value['weight_id'] ?>" readonly>
                                            <button id="counter-increment" class="increment  cart-qty-plus_c"
                                                data-product_weight_id="<?= $value['product_weight_id'] ?>">+</button>
                                        </div>
                                    </div>
                                </td>
                                <td>
                                    <div class="cart-price-text">
                                        ...
                                        <a href="#" class="removeCartItem" data-product_id="<?= $value['product_id'] ?>"
              ...
              ?>
                    ...
                    <div>
                        <button type="button" class="lg-btn clear-btn"
                            id="ClearCart"><?=$this->lang->line('clear cart')?></button>
                    </div>
                </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-12 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0"
                data-wow-offset="0">
