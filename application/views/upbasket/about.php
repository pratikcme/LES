...
<section class="about-us-section section">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6 wow fadeInLeftBig" data-wow-duration="1.5s"
            ...
            <div class=" col-xxl-6 col-xl-6 col-lg-6 col-md-6 wow fadeInRightBig" data-wow-duration="1.5s"
                data-wow-delay="0" data-wow-offset="0">
                <div class="about-image-parts">
                    <img src="<?= $this->theme_base_url ?>/assets/images/about-rectangl-1.svg" alt=""
                        class="about-rectangl-1">
                    <img src="<?= $this->theme_base_url ?>/assets/images/about-rectangl-2.svg" alt=""
                        class="about-rectangl-2">
