              ...
              <div class="col-xxl-6 col-xl-6 col-md-12 wow bounceIn" data-wow-duration="1s" data-wow-delay="0s"
                  ...
                  <form id="form" method="post" action="<?= base_url() . 'contact' ?>">
                      <div class="left-contact-wrapper">
                          ...
                          <div class="mb-3">
                              <label for="exampleInputEmail1" class="form-label"><?= $this->lang->line('Email') ?>
                              </label>
                          ...
                          <div class="mb-3">
                              ...
                              <input type="tel" name="mobile_no" class="form-control" id="phone-num"
                                  aria-describedby="phone-num" placeholder="<?= $this->lang->line('Phone') ?>">
                          ...
                          <div class="mb-3">
                              ...
                              <textarea name="message" cols="0" rows="0"
                                  placeholder="<?= $this->lang->line('Message') ?>"></textarea>
                              <label for="message" class="error"><?= form_error('message') ?></label>
                          </div>
                          <div class="submit-btn">
                              <button type="submit" class="common-input-btn btn" name="submit"
                                  id="btnSubmit"><?= $this->lang->line('send') ?></button>
                              <!-- <a href="#" >Submit</a> -->
                          </div>
                  </form>
              </div>
