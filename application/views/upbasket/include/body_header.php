    ...
    <div class="row">
            ...
            <div class="header-top">
                ...
                <div class="search-btn">
                    <div class="input-group">
                        ...
                        if ($segment1 != '') { ?>
                            <input type="text" class="form-control search" id="globalSearch" data-search_val="" placeholder="<?= $placeholder ?>" autocomplete="off">
                            <span class="input-group-text"><span><i class="fa-solid fa-magnifying-glass"></i></span>
                                Search</span>
                        <?php } ?>
                    </div>
        ...
        <div class="mobile-search-btn">
            <div class="input-group">
                ...
                if ($segment1 != '') { ?>
                    <input type="text" class="form-control search" id='myInputMobile' data-search_val="" placeholder="<?= $placeholder ?>">
                    <span class="input-group-text"><span><i class="fa-solid fa-magnifying-glass"></i></span></span>
                <?php } ?>
            </div>
        </div>
