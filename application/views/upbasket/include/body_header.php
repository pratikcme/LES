            ...
            <div class="header-top">
                ...
                <div class="social-icons">
                    <div class="user-btn btn-group">
                        <button class="dropdown-toggle user-login-icon border-0" type="button"
                            ...
                            <svg width="18" height="17" viewBox="0 0 18 17" fill="none"
                                ...
                                <path
                                    d="M9 11.5C11.7614 11.5 14 9.26142 14 6.5C14 3.73858 11.7614 1.5 9 1.5C6.23858 1.5 4 3.73858 4 6.5C4 9.26142 6.23858 11.5 9 11.5Z"
                                    stroke="#222528" stroke-width="1.5" stroke-miterlimit="10" />
                                <path
                                    d="M1.42188 15.875C2.18979 14.5447 3.2944 13.4399 4.62465 12.6718C5.9549 11.9037 7.46392 11.4993 9 11.4993C10.5361 11.4993 12.0451 11.9037 13.3753 12.6718C14.7056 13.4399 15.8102 14.5447 16.5781 15.875"
                                    stroke="#222528" stroke-width="1.5" stroke-linecap="round"
                    ...
                    <div class="cart-btn btn-group <?= (empty($this->cartCount)) ? 'no-itm' : '' ?>">
                        <button class="cart-icons dropdown-toggle border-0" type="button"
                            id="dropdownMenuClickableInside" data-bs-toggle="dropdown" data-bs-auto-close="outside"
                            aria-expanded="false">
                            ...
                            <svg width="18" height="18" viewBox="0 0 18 18" fill="none"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                                    d="M14.375 13.375H5.45313L3.27344 1.39063C3.24793 1.2471 3.17307 1.11701 3.06179 1.02285C2.95051 0.928697 2.80982 0.876396 2.66406 0.875H1.25"
                                    stroke="#222528" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M6.25 16.5C7.11294 16.5 7.8125 15.8004 7.8125 14.9375C7.8125 14.0746 7.11294 13.375 6.25 13.375C5.38706 13.375 4.6875 14.0746 4.6875 14.9375C4.6875 15.8004 5.38706 16.5 6.25 16.5Z"
                                    stroke="#222528" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M14.375 16.5C15.2379 16.5 15.9375 15.8004 15.9375 14.9375C15.9375 14.0746 15.2379 13.375 14.375 13.375C13.5121 13.375 12.8125 14.0746 12.8125 14.9375C12.8125 15.8004 13.5121 16.5 14.375 16.5Z"
                                    stroke="#222528" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                                <path
                                    d="M4.88281 10.25H14.6953C14.9875 10.2509 15.2706 10.1488 15.4949 9.96159C15.7193 9.77442 15.8704 9.51416 15.9219 9.22656L16.875 4H3.75"
                                    stroke="#222528" stroke-width="1.5" stroke-linecap="round"
                                    stroke-linejoin="round" />
                            </svg>
                                ...
                                <li>
                                    <div class="cart-drop-menu cart-drop-menu-1">
                                        ...
                                        <div class="cancel-btn remove_item"
                                            ...
                                            <a href="javascript:" class="ms-0"><i
