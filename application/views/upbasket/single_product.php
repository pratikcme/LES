...
#starRatting {
  ...
  <section class="product-detalis-section">
      <img src="<?= $this->theme_base_url ?>/assets/images/product-detail-top-left-img.png" alt=""
          class="product-detail-top-left-img">
      <img src="<?= $this->theme_base_url ?>/assets/images/product-detail-top-right-img.png" alt=""
          class="product-detail-top-right-img">
      <div class="container">
          <div class="row">
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                  <div class="product-image-part">
                      ...
                      <div style="--swiper-navigation-color: #fff; --swiper-pagination-color: #fff"
                          ...
                          <span
                              class="discnt <?= ($varientDetails[0]->discount_per > 0) ? '' : 'd-none' ?>"><?= $varientDetails[0]->discount_per ?>
                              % off</span>
                          <div class="pro-hearticon wishlist-icon" data-product_id="<?= $product_id ?>"
                              data-product_weight_id="<?= $product_weight_id ?>">
                              <i
                                  class="fa-regular fa-heart <?= (in_array($this->utility->safe_b64decode($product_weight_id), $wish_pid)) ? "fa-solid" : "" ?>"></i>
                          </div>
                      ...
                      <div class="product-detalis-btn">
                          ...
                          <div class="product-detail-quentity <?= $d_show ?>">
                              <div class="qty-container">
                                  <button class="dec qty-btn-minus cart-qty-minus decqnt" type="button"
                                      data-product_weight_id="<?= $varientDetails[0]->id ?>"><i
                                          class="fa-solid fa-minus"></i></button>
                                  <input type="text" name="qty" id="qnt"
                                      value="<?= ($cartQuantityForVarient != '') ? $cartQuantityForVarient : 1 ?>"
                                      data-product_id="<?= $this->utility->safe_b64decode($product_id) ?>"
                                      class="input-qty">
                                  <button class="inc qty-btn-plus cart-qty-plus incqnt" type="button"
                                      data-product_weight_id="<?= $varientDetails[0]->id ?>"><i
                                          class="fa-solid fa-plus"></i></button>
                              </div>
                          </div>
                          <?php if ($isAvailable != '0') { ?>
                          <a href="javascript:" id="order_now" class="add-cart-btn order-now"><span><i
                  ...
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item" role="presentation">
                          <button class="nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home"
                              ...
                              aria-selected="true"><?= $this->lang->line('Description') ?></button>
                      </li>
                      <li class="nav-item" role="presentation">
                          <button class="nav-link" id="info-tab" data-bs-toggle="tab" data-bs-target="#info"
                              type="button" role="tab" aria-controls="info"
                              aria-selected="false"><?= $this->lang->line('Information') ?></button>
                      </li>
                      <li class="nav-item" role="presentation">
                          <button class="nav-link" id="review_count" data-bs-toggle="tab" data-bs-target="#profile"
                              type="button" role="tab" aria-controls="profile"
                              aria-selected="false"><?= $this->lang->line('Reviews') ?>
                          ...
                          <div class="my-review-wrapper">
                              ...
                              <div class="row ">
                                  <div class="col-xxl-8 col-xl-8 col-lg-8">
                                      <div class="review-comment-wrapper <?= (count($product_review) == 0) ? 'd-none' : '' ?>"
                                          id="review_section">
                                              ...
                                              <div class="rewiew-wrapper">
                                                  <div class="review-right">
                                                      <div class="review-right-top">
                                                          <span class="number-star"> <span><i
                                                                      class="fa-solid fa-star"></i></span><?= $value->ratting ?></span>
                                                          <h4><?= $value->title ?></h4>
                                                      </div>
                                                      <h6><?= $value->fname ?> on
                                                          <?= date('M d, Y', strtotime($value->dt_created)) ?> </h6>
                                                      <p><?= $value->review ?></p>
                                                  </div>
                                              </div>
                                              <?php } ?>
                                  ...
                                  <div class="col-xxl-4 col-xl-4 col-lg-4 <?= (!empty($isVarientExist) || $countParticularUserReview >= 1) ? 'd-none' : '' ?>"
                                      id="writeReviewSection">
                                      <div class="add_review_wrapper">
                                          <h3><?= $this->lang->line('Add a review') ?></h3>

                                          <form id="reviewForm" class="rating" method="POST"
                                              action="<?= base_url() . 'products/productReview' ?>">
                                              <!-- <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="full-name" placeholder="Enter Your name">
                                              ...
                                              <div class="rating-box">
                                                  ...
                                                  <div class="rating__stars">
                                                      <input id="rating-1" class="rating__input rating__input-1"
                                                          type="radio" name="ratetIndex" value="1">
                                                      <input id="rating-2" class="rating__input rating__input-2"
                                                          type="radio" name="ratetIndex" value="2">
                                                      <input id="rating-3" class="rating__input rating__input-3"
                                                          type="radio" name="ratetIndex" value="3">
                                                      <input id="rating-4" class="rating__input rating__input-4"
                                                          type="radio" name="ratetIndex" value="4">
                                                      <input id="rating-5" class="rating__input rating__input-5"
                                                          type="radio" name="ratetIndex" value="5">
                                                      <label class="rating__label" for="rating-1">
                                                          <svg class="rating__star" width="32" height="32"
                                                              viewBox="0 0 32 32" aria-hidden="true">
                                                              <g transform="translate(16,16)">
                                                                  <circle class="rating__star-ring" fill="none"
                                                                      stroke="#000" stroke-width="16" r="8"
                                                                      transform="scale(0)" />
                                                              </g>
                                                              <g stroke="#000" stroke-width="2" stroke-linecap="round"
                                                                  ...
                                                                  <g transform="translate(16,16)"
                                                                      stroke-dasharray="12 12" stroke-dashoffset="12">
                                                                      <polyline class="rating__star-line"
                                                                          transform="rotate(0)" points="0 4,0 16" />
                                                                      <polyline class="rating__star-line"
                                                                          transform="rotate(72)" points="0 4,0 16" />
                                                                      <polyline class="rating__star-line"
                                                                          transform="rotate(144)" points="0 4,0 16" />
                                                                      <polyline class="rating__star-line"
                                                                          transform="rotate(216)" points="0 4,0 16" />
                                                                      <polyline class="rating__star-line"
                                                                          transform="rotate(288)" points="0 4,0 16" />
                                                                  </g>
                                                              </g>
                                                          </svg>
                                              ...
                                              <input type="hidden" name="varient_id" id="varient_id"
                                                  value="<?= $this->uri->segment(4) ?>">

                                              <div class="review-text-box">
                                                  <label
                                                      for="Your-review"><?= $this->lang->line('Your review') ?></label>
                                                  <textarea name="comment" id="Your-review" cols="30" rows="10"
                                                      placeholder="enter your message"></textarea>
                                              </div>
                                              <button type="submit" id="btnSubmit1"
                                                  class="add-cart-btn"><?= $this->lang->line('Submit') ?></button>
                                          </form>
                                      </div>
                                  </div>
                              </div>
  ...
  <section class="Latest-Products Categories-section related-product-section section">
      ...
      <img src="<?= $this->theme_base_url ?>/assets/images/related-product-top-right.png" alt=""
          class="related-product-top-right">
      <div class="container">
