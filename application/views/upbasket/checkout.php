                            ...
                            <div class="accordion-content accordion-content-3">
                                ...
                                <form method="post" id="RegisterForm"
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <label for="fname"
                                                class="form-label"><?= $this->lang->line('Full Name') ?><span>*</span>
                                            </label>
                                ...
                                <tr>
                                    ...
                                    <td class="cart-total-text-2">
                                        ...
                                        <span id="checkout_subtotal">
                                            <?php // ($isShow[0]->display_price_with_gst == '1') ? numberFormat($getMycartSubtotal) : numberFormat($getMycartSubtotal - $TotalGstAmount)  
                        ...
                        <div class="secure-product-wrapper">
                            <div class="icon">
                                <a href="javascript:"><img
                                        src="<?= $this->theme_base_url ?>/assets/images/ShieldCheck.svg" alt=""></a>
                            </div>
                            <div class="text">
    ...
    <div class="container">
        <div class="modal-content">
            ...
            <div class="login-page">
                <div class="container">
                    <img src="<?= $this->theme_base_url ?>/assets/images/login-center-border-img.png" alt=""
                        class="login-center-border-img">
