        ...
        <div class="row state-overview">
            ...
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <a href="<?php echo base_url() . 'order'; ?>">
                        <div class="value">
                            <h1 class="dashboard_color"><?php echo $total_order_delt['total']; ?></h1>
                            <p>Total Order</p>
                        </div>
                    </a>
                </section>
            ...
            <div class="col-lg-3 col-sm-6">
                <section class="panel">
                    ...
                    <a href="<?php echo base_url() . 'order'; ?>">
                        <div class="value">
                            <h1 class="dashboard_color"><?php echo $total_delivered['total_delivered']; ?></h1>
                            <p>Total Delivered</p>
                        </div>
                    </a>
                </section>
                    ...
                    <div class="col-md-6">
                        <div class="box-small-area">
                            ...
                            <section class="panel">
                                ...
                                <a href="#">
                                    <div class="value">
                                        <h1 class="dashboard_color"><?php echo $total_pending_order['total'] ?></h1>
                                        <p>pending orders</p>
                                    </div>
                                </a>
                            </section>
                                ...
                                <a href="#">
                                    <div class="value">
                                        <h1 class="dashboard_color">
                                            <?php echo  number_format($total_pending_payment['pending_payment'], 2, '. ', '') ?>
                                        </h1>
                                        <p>pending payment</p>
                                    </div>
                                </a>
                    ...
                    <div class="col-md-6">
                        <div class="box-small-area">
                            ...
                            <section class="panel">
                                ...
                                <a href="#">
                                    <div class="value">
                                        <h1 class="dashboard_color"><?php echo $total_return_order['total']; ?></h1>
                                        <p>Cancel orders</p>
                                    </div>
                                </a>
                            </section>
                    ...
                    <div class="col-md-6">
                        <div class="box-small-area">
                            ...
                            <section class="panel">
                                ...
                                <a href="#">
                                    <div class="value">
                                        <h1 class="dashboard_color"><?php if (isset($total_return_payment['return_payment']) && $total_return_payment['return_payment'] > 0) {
                                                                        echo number_format((float)$total_return_payment['return_payment'], 2, '.', '');
                                                                    } else {
                                                                        echo 0;
                                                                    } ?></h1>
                                        <p>return payment</p>
                                        ...
                                        <td>
                                            <?php
                                                if ($result->order_status == '1') {
                                                    ...
                                                    echo "<label class='badge badge-gradient-default'>Pickup</label>";
