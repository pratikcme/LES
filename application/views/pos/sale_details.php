        ...
        <ul>
            ...
            <li>
                <div>
                    <h6>Total </h6>
                    <h6><?= $currency . ' ' ?>
                        <?= $total_discounted_gst > 0 ? numberFormat($orderInfo->total + $total_discounted_gst - $basedDiscount)  : ((isset($basedDiscount) && $basedDiscount > 0) ? numberFormat(numberFormat($orderInfo->total + $total_gst_amount) - $basedDiscount) : numberFormat($orderInfo->total + $total_gst_amount)) ?>
                    </h6>
                </div>
            </li>
        </ul>
