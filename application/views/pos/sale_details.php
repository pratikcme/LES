...
<div class="supportive-div">
    ...
    <div class="order_data_view">
        ...
        <ul>
            ...
            // dd(numberFormat($orderInfo->total + $total_gst_amount));
            // dd(numberFormat($orderInfo->total + $total_discounted_gst - $basedDiscount));
            ?>
            <li>
                <div>
                    <h6>Total </h6>
                    <h6><?= $currency . ' ' ?>
                        <?= $total_discounted_gst > 0 ? numberFormat($orderInfo->total + $total_discounted_gst - $basedDiscount)  :  numberFormat($orderInfo->total + $total_gst_amount) ?>
                    </h6>
                </div>
            </li>
        </ul>
