    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/index'; ?>">Home</a> / sell report</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading"> Sell report</header>
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="most_sell_report" aria-describedby="example_info">
                                    ...
                                    <tr role="row">
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            rowspan="1" colspan="1"
                                            aria-label="Rendering engine: activate to sort column ascending"
                                            style="width: 100px;">varient
                                        </th>
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            rowspan="1" colspan="1"
                                            aria-label="Platform(s): activate to sort column ascending"
                                            style="width: 100px;">sell quantity
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($most_sell as $key => $value) { ?> 
                                    <tr>
                                        <td><?=$value->product_name?></td>
                                        <td><?=$value->weight_no .' '.$value->weight_name ?></td>
