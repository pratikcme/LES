    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-3 col-lg-12">
                <div class="title">
                    <h2 class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0"><?=$this->lang->line('Hot Products')?></h2>
                </div>
            </div>
            ...
            <div class="col-xl-3 col-lg-4">
                <div class="text-end product-btn-wrap">
                    <a href="./product-list-page.php" class="border-btn wow fadeInRight" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0"><?=$this->lang->line('All Produts')?> 
                        ...
                        ?>
                            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6 mb-4">
                                <div class="hot-products-wrap">
                                    ...
                                    <div class="hot-products-details">
                                        <a href="./product-details.php"><h5><?=$value->name?></h5></a>
                                        <div class="price-wrap notranslate d-flex">
                                            <p><span <?= ($value->discount_per > 0) ? '' : 'd-none' ?>><strike><?= $this->siteCurrency . '' . number_format((float)$value->price, 2, '.', '') ?></strike></span> </p>
                                            <h6><?= $this->siteCurrency . ' ' . number_format((float)$value->discount_price, 2, '.', '') ?></h6>
                                        </div>
                                        <div class="rating-starts rating-furni">
                                            <div class="rating stars3_5">
