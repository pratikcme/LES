                        ...
                        <div class="product-detail-quentity wow fadeInRight mt-0" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                            ...
                            <div class="product-detail-quentity mt-0 <?= $d_show ?>">
                                <div class="qty-container">
                                    <button class="dec decqnt dec_<?= $varientDetails[0]->id ?> cart-qty-minus qty-btn-minus productDetailsButton" type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i class="fa-solid fa-minus"></i></button>
                                    ...
                                    <button class="inc qty-btn-plus inc_<?= $varientDetails[0]->id ?> cart-qty-plus incqnt" type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i class="fa-solid fa-plus"></i></button>
                                </div>
                            </div>
                        </div>
                        <?php if ($isAvailable != '0') { ?>
            ...
            <div class="col-xxl-12">
                <div class="review-desc">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item review_show" role="presentation">
