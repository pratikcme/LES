            ...
            <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12">
                <div class="product-content-part zoom">
                    ...
                    <div class="product-detalis-btn wow fadeInRight" data-wow-duration="1s" data-wow-delay="0"
                        data-wow-offset="0">
                        <div class="product-detail-quentity wow fadeInRight mt-0" data-wow-duration="1s"
                            data-wow-delay="0" data-wow-offset="0">
                            <?php if ($isAvailable != '0') { ?>
                            <a href="javascript:" class="add-cart-btn cmn-btn <?= $d_none ?>" id="addtocart"><span><i
                                        class="fa-solid fa-cart-shopping "></i></span>Add To Cart</a>
                            <?php } ?>
                            <div class="product-detail-quentity mt-0 <?= $d_show ?>">
                                <div class="qty-container">
                                    <button
                                        class="dec decqnt dec_<?= $varientDetails[0]->id ?> cart-qty-minus qty-btn-minus productDetailsButton"
                                    ...
                                    <button
                                        class="inc qty-btn-plus inc_<?= $varientDetails[0]->id ?> cart-qty-plus incqnt"
                                        type="button" data-product_weight_id="<?= $varientDetails[0]->id ?>"><i
                        ...
                        <?php if ($isAvailable != '0') { ?>
                        <a href="javascript:" id="order_now" class="add-cart-btn order-now cmn-btn"><span><i
                                    class="fa fa-arrow-circle-right" aria-hidden="true"></i></span>Order Now</a>
                        <?php } ?>
                        ...
                        ?>
                        <a href="https://wa.me/<?= $mobile ?>/?text=<?= $url ?>" id='whatsapp_link' target="_black"
            ...
            <div class="col-xxl-12">
                <div class="review-desc">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane mt-4 fade show active" id="home" role="tabpanel"
                                ...
                                <div class="review-content">
                                    <div class="left-content">
                                        <div class="notranslate">
                                            <h3><strong
                                                    id="avgRating"><?= $productDetail[0]->rating['rating'] ?></strong><span>/5</span>
                                            </h3>
                                        </div>
                                        <div>
                                    ...
                                    <div class="right-content" id="writeReviewSection">
                                        <div class="enter-review-btn">
                                            <a href="#" type="button" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal"><?= $this->lang->line('Write Review') ?></a>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
                            ...
                            <div class="hot-products-wrap  <?= ($value->quantity == '0') ? 'out-of-stock' : '' ?>">
                                <div class="hot-products-img position-relative overflow-hidden">
                                    ...
                                    <div class="hot-products-cart-wrap">
                                        <a href="javascript:"
                                            class="addcartbutton product_<?= $this->utility->safe_b64encode($value->id) ?> <?= $d_none ?>"
                                ...
                                <div class="hot-products-details ">
                                    ...
                                    <div class="rating-starts rating-furni">
                                        ...
                                        <div>
                                            <p>( <?= $value->reviewCount . ' ' . $this->lang->line('Reviews') ?> )
                                            </p>
                                        </div>
                                    </div>
                                    <?php
...
<div class="modal fade my-review-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form class="modal-body" id="reviewForm" class="modal-body rating flex-column" method="POST"
