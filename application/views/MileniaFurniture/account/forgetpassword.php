        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">
              <?= $this->lang->line('My account') ?></li>
            <!-- ask to add language later DK My account temp-->
          </ol>
        </nav>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-xxl-6 col-lg-6 col-md-12">
        ...
        <div class="login-left-content">
          ...
          <form class="login-deatils-wrapper signin-deatils-wrapper forgot-deatils-wrapper " id="ForgetForm" method="post" action="<?= base_url() . 'login/forget_password' ?>">
            ...
            <div class="mb-3">
              ...
              <input type="email" class="form-control" id="email" name="email" aria-describedby="emailHelp" placeholder="<?= $this->lang->line('Enter Email*') ?>">
              <label for="email" class="error"><?= @form_error('email') ?></label>
            </div>

            <div class="sign-in-btn reset-password-btn">
              <button type="submit" id="btnSubmit" class="cmn-btn"><?= $this->lang->line('Reset Password') ?></button>
            </div>
