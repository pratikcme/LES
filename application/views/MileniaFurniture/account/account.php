     ...
     <div class="container">
         ...
         <div class="account-details-tabs">
             <div class="details-tabs">
                 ...
                 <ul class="nav nav-pills" role="tablist">
                     <li class="nav-item">
                         <a class="nav-link dashboard-tabs <?= ($action_name == 'my_account' || $action_name == '') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-1"><?= $this->lang->line('My account') ?></a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link dashboard-tabs experience-active-img <?= ($action_name == 'order') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-2"><?= $this->lang->line('My orders') ?></a>
                     </li>
                     <li class="nav-item">
                     ...
                     <li class="nav-item">
                         <a class="nav-link dashboard-tabs certificates-active-img <?= ($action_name == 'my_address') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-4"><?= $this->lang->line('My address') ?></a>
                     </li>
                     <li class="nav-item">
                         <a class="nav-link dashboard-tabs certificates-active-img <?= ($action_name == 'change') ? 'active' : '' ?>"
                             data-bs-toggle="pill" href="#tab-7"><?= $this->lang->line('Change Password') ?></a>
                     </li>
                     <li class="nav-item">
             ...
             <div class="tab-details">
                 <div class="tab-content">
                     <!-- ---tab-1-- -->
                     <div id="tab-1"
                         class="container tab-pane fade <?= ($action_name == 'my_account' || $action_name == '') ? 'active show' : '' ?>">
                                 ...
                                 <form id='ChangePass' enctype="multipart/form-data"
                                     ...
                                     <div class="row">
                                         ...
                                         <div class="col-xxl-6 col-md-6">
                                             <div class="mb-3">
                                                 ...
                                                 <input type="text" class="form-control" id="lname" name="lname"
                                                     aria-describedby="lname" value="<?= $userDetails[0]->lname ?>"
                                         ...
                                         <div class="col-xxl-12">
                                             <div class="mb-3">
                                                 <label for="email"
                                                     class="form-label"><?= $this->lang->line('Email Address') ?><span>*</span></label>
                                         ...
                                         <div class="col-xxl-6 col-md-6">
                                             <div class="tab-select-box">
                                                 <label for="country_code"
                                                     class="form-label"><?= $this->lang->line('Country Code') ?><span>*</span></label>
                                         ...
                                         <div class="col-xxl-12 col-md-12 varification" style="display: none;">
                                             <div class="mb-3">
                                                 <label for="otp"
                                                     class="form-label"><?= $this->lang->line('Otp') ?><span>*</span></label>
                                                 <input type="text" class="form-control" id="otp" name="otp"
                                                     placeholder="<?= $this->lang->line('Otp') ?>">
                                             </div>
                                         </div>
                                         <div class="tab-save-btn">
                                             <button id="btnAccSubmit" class="cmn-btn"
                                                 type="submit"><?= $this->lang->line('Save') ?></button>
                                         </div>
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <div class="cart-detail-text">
                                                 <h4><a
                                                         href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->product_id) . '/' . $this->utility->safe_b64encode($value->product_weight_id) ?>"><?= $value->name ?></a>
                                                 </h4>
                                                 <!-- <p>Qty: <span>1</span></p> -->
                                             </div>
                                         </td>
                                         <td>
                                             <div class="cart-price-text cart-disc notranslate">
                                                 <span
                                                     class="disc-throw <?= ($value->discount_per == '0') ? 'd-none' : '' ?>"><?= $this->siteCurrency . ' ' . numberFormat($value->price) ?></span>
                                                 <h3 class="">
                                                     <?= $this->siteCurrency . ' ' . numberFormat($value->discount_price) ?>
                                                 </h3>
                                             </div>
                                         ...
                                         <td>
                                             <div>
                                                ...
                                                Cart</a> -->
                                                 <a href="javascript:"
                                                     class="add-cart-btn addcartbutton_wishlist <?= $d_none ?>"
                                                 ...
                                                 <div class="product-detail-quentity <?= $d_show ?>">
                                                     <div class="qty-container">
                                                         <button class="qty-btn-minus dec cart-qty-minus whishlist_area"
                     ...
                     <div id="tab-4" class="container tab-pane fade">
                         ...
                         <div class="edit-address-btn text-center ">
                             <button type="button" id="myBtn" class="cmn-btn"
                                 data-toggle="modal"><?= $this->lang->line('Add Address') ?></button>
                         </div>
                     ...
                     <div id="tab-7"
                         ...
                         <div class="myaccout-detail-tab">
                             <form id='ChangeUserPass'
                                 action="<?= base_url() . 'users_account/users/update_password' ?>" method="post">
                                 <div class="row">
                                     <div class="col-lg-12">
                                         <div class="mb-3">
                                             <label for="text"
                                     ...
                                     <div class="tab-save-btn">
                                         <button class="cmn-btn" id="btnChangeUserPass"
 ...
 <div id="myModal" class="modal">
     <div class="container">
         <div class="modal-content">
             ...
             <div class="login-page myaccout-detail-tab">
                 <h3 id='address_title'><?= $this->lang->line('Add New Address') ?></h3>
                 <form class="get-detials-account" method="post" id="RegisterForm"
                     action="<?= base_url() . 'users_account/users/add_address' ?>" autocomplete="off">
                     <div class="row">
                         <div class="col-lg-12">
                             <label for="full_name"
                                 class="form-label"><?= $this->lang->line('Full Name') ?><span>*</span></label>
                             <input type="text" name="fname" class="form-control fname" id="full_name"
                                 aria-describedby="fname" placeholder="<?= $this->lang->line('Full Name') ?>">
                         </div>
                         ...
                         <div class="col-lg-12">
                             <div class="select-box">
                                 ...
                                 <textarea name="address" placeholder="<?= $this->lang->line('Enter Address') ?>"
                                     class="form-control pincode" id="address" autocomplete="off"></textarea>
                             </div>
                         </div>
