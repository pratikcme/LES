                    ...
                    <div class="hot-products-wrap <?= ($value->available_quantity == '0') ? 'out-of-stock' : '' ?>">
                        <div class="hot-products-img position-relative overflow-hidden">
                            ...
                            <div class="hot-products-cart-wrap">
                                ...
                                <!-- <a href="#"><img src="./assets/images/home/like.svg" alt="light" /></a> -->
                        ...
                        <div class="hot-products-details ">
                            ...
                            <a href="javascript:;" class="add-cart-btn cmn-btn addcartbutton <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_varient_id) ?>"><span><i class="fa-solid fa-cart-shopping "></i></span><?= $this->lang->line('add to cart') ?></a>
                            ...
                            <div class="product-detail-quentity add-cart-btns <?= $d_show ?>">
                                <div class="qty-container">
                                    ...
                                    <input type="text" name="qty" value="<?= ($value->my_cart_quantity != '0') ? $value->my_cart_quantity : 1 ?>" class="input-qty qty" data-product_id="<?= $value->product_id ?>" data-weight_id="<?= $value->product_varient_id ?>">
