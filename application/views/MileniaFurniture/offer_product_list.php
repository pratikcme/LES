<!-- ----hero-section-- -->
<section class="hero-section banner common-banner-bg login-section">
    <div class="container">
        <div class="row">
                    ...
                    <div class="hot-products-wrap <?= ($value->available_quantity == '0') ? 'out-of-stock' : '' ?>">
                        <div class="hot-products-img position-relative overflow-hidden">
                            ...
                            <div class="hot-products-cart-wrap">
                                <a href="javascript:;" class="addcartbutton product_<?= $this->utility->safe_b64encode($value->id) ?> <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_varient_id) ?>"><svg width="22" height="20" viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <a href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->product_id) . '/' . $this->utility->safe_b64encode($value->product_varient_id) ?>"><svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div class="techno-check">
                                    <input class="techno_checkbox  wishlist-icon" type="checkbox" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-product_weight_id="<?= $this->utility->safe_b64encode($value->product_varient_id) ?>" <?= (in_array($value->product_varient_id, $wish_pid)) ? "checked" : "" ?>>
                        ...
                        <div class="hot-products-details ">
                            ...
                            <div class="price-wrap d-flex">
                                <p class="<?= ($value->new_percentage > 0) ? '' : ' d-none' ?>">
                                    <span><strike><?= $this->siteCurrency . ' ' . $value->price ?></strike></span>
                                </p>
                            ...
                            <div class="product-detail-quentity add-cart-btns <?= $d_show ?>">
                                <div class="qty-container">
                                    ...
                                    <input type="text" name="qty" value="<?= ($value->my_cart_quantity != '0') ? $value->my_cart_quantity : 1 ?>" class="input-qty qty" data-product_id="<?= $value->product_id ?>" data-weight_id="<?= $value->product_varient_id ?>" readonly>
