                    ...
                    <div class="hot-products-img position-relative overflow-hidden">
                        ...
                        <div class="hot-products-cart-wrap">
                            <a href="javascript:;" class="addcartbutton <?= $d_none ?>"
                                ...
                                data-varient_id="<?= $this->utility->safe_b64encode($value->product_varient_id) ?>"><svg
                            ...
                            <a
                                href="<?= base_url() . 'products/productDetails/' . $this->utility->safe_b64encode($value->product_id) . '/' . $this->utility->safe_b64encode($value->product_varient_id) ?>"><svg
                            ...
                            <div class="techno-check">
                                <input class="techno_checkbox  wishlist-icon" type="checkbox"
                                    data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>"
                                    data-product_weight_id="<?= $this->utility->safe_b64encode($value->product_varient_id) ?>"
                                    <?= (in_array($value->product_varient_id, $wish_pid)) ? "checked" : "" ?>>
                        ...
                        <div class="product-detail-quentity add-cart-btns <?= $d_show ?>">
                            <div class="qty-container">
                                ...
                                <input type="text" name="qty"
                                    ...
                                    class="input-qty qty" data-product_id="<?= $value->product_id ?>"
                                    data-weight_id="<?= $value->product_varient_id ?>" readonly>
