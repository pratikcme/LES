                ...
                <div class="footer-wrap">
                    ...
                    <div class="download-app-wrap">
                        ...
                        <div class="store-wrap">
                            <a href="<?= (!empty($appLinks)  && $appLinks[0]->ios_app_link != '') ? $appLinks[0]->ios_app_link : "#" ?>"><img src="<?= $this->theme_base_url ?>/assets/images/footer/app-store.png" alt="app-store" /></a>
                            <a href="<?= (!empty($appLinks) && $appLinks[0]->android_app_link != '') ? $appLinks[0]->android_app_link : "#" ?>"><img src="<?= $this->theme_base_url ?>/assets/images/footer/google-play.png" alt="google-play" /></a>
                        </div>
                    </div>
            ...
            <div class="col-lg-2 col-md-4 col-sm-6 wow zoomIn" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                <div class="footer-wrap">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= base_url() . 'users_account/users/account?name=my_account' ?>"><?= $this->lang->line('My account') ?></a>
                        </li>
                        <li><a href="<?= base_url() . 'users_account/users/account?name=wishlist' ?>"><?= $this->lang->line('Wishlist') ?></a>
                        </li>
                ...
                <div class="footer-wrap">
                    ...
                    <ul>
                        <?php foreach ($CategoryHighrstProduct as $key => $value) { ?>
                            <li><a href="<?= base_url() . 'products?cat_id=' . $this->utility->safe_b64encode($value->id) ?>"><?= $value->name ?></a>
                            </li>
                        <?php } ?>
            ...
            <div class="col-lg-12">
                <div class="copyright-text">
                    ...
                    <div class="social-icons">
                        <a href="<?= (@$appLinks[0]->facebook_link != '') ? @$appLinks[0]->facebook_link : 'javascript:' ?>"><img src="<?= $this->theme_base_url ?>/assets/images/footer/fb.svg" alt=""></a>
                        <a href="<?= (@$appLinks[0]->instagram_link != '') ? @$appLinks[0]->instagram_link : 'javascript:' ?>"><img src="<?= $this->theme_base_url ?>/assets/images/footer/insta.svg" alt=""></a>
                        <a href="<?= (@$appLinks[0]->twitter_link != '') ? @$appLinks[0]->twitter_link : 'javascript:' ?>"><img src="<?= $this->theme_base_url ?>/assets/images/footer/twiter.svg" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
