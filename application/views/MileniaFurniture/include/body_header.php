            ...
            <div class="navbar-collapse justify-content-end">
              ...
              <div class="drp-grp">
                ...
                <?php if ($this->uri->segment(1) != 'login' && $this->uri->segment(1) != '') {
                  if ($ApprovedBranch[0]->approved_branch >= '1'  && count($branch_nav) >= '1') {
                ?>
                ...
                <div class="searchbar">
                  ...
                  <div class="search-block search-list-blcok">
                    <form class="search-form">
                      ...
                      if ($segment1 != '') { ?>
                        <input type="text" class="form-control search-input search" id='myInput' data-search_val="" placeholder="<?= $placeholder ?>">
                        <i class="fa-solid fa-magnifying-glass search-here-icon"></i>
                  ...
                  <ul class="dropdown-menu cart-dropdowns" aria-labelledby="dropdownMenuClickableInside">
                    ...
                    <li>
                      <div class="cart-drop-menu cart-drop-menu-1">
                        <div class="drop-img">
                          <a href="./product-details.html"><img src="./assets/images/header/image1.png" alt=""></a>
                        </div>
                        <div class="drop-text">
                          <a href="./product-details.html">
                            <h4>Wooden Dining Chair</h4>
                          </a>
                          <p>Qty : <span>2</span> </p>
                          <h3>₹1150.00</h3>
                        </div>
                    ...
                    <li>
                      <div class="cart-drop-menu cart-drop-menu-1">
                        <div class="drop-img">
                          <a href="./product-details.html"><img src="./assets/images/header/image2.png" alt=""></a>
                        </div>
                        <div class="drop-text">
                          <a href="./product-details.html">
                            <h4>Della Chair – Navy</h4>
                          </a>
                          <p>Qty : <span>2</span> </p>
                          <h3>₹2250.00</h3>
                        </div>
                    ...
                    <li>
                      <div class="cart-drop-menu cart-drop-menu-1">
                        <div class="drop-img">
                          <a href="./product-details.html"><img src="./assets/images/header/image3.png" alt=""></a>
                        </div>
                        <div class="drop-text">
                          <a href="./product-details.html">
                            <h4>Artemis Lounge Chair</h4>
                          </a>
                          <p>Qty : 2</p>
                          <h3>₹1249.00</h3>
                        </div>
              ...
              <div class="header-card-btn btn-group">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuClickableInside">
                  <li>
                    <div class="cart-drop-menu cart-drop-menu-1">
                      <div class="drop-img">
                        <a href="./product-details.html"><img src="./assets/images/cart-drop-img-1.png" alt=""></a>
                      </div>
                      <div class="drop-text">
