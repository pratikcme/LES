  ...
  <div class="container">
    <div class="mobile-nav">
      <ul>
        ...
        <li><a href="<?= base_url() ?>login"><span><i class="fa-solid fa-user"></i></span><?= $this->lang->line('About Us') ?></a></li>
        <li><a href="<?= base_url() ?>contact"><span><i class="fa-solid fa-circle-user"></i></span><?= $this->lang->line('Contact Us') ?></a>
        </li>
      </ul>
    </div>
  </div>
