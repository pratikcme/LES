...
<div class="product-listing-wrapper hot-products-wrap wow fadeInDown <?= ($value->quantity == '0') ? 'out-of-stock' : '' ?>" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
    ...
    <div class="hot-products-details">
        ...
        <a href="javascript:;" class="add-cart-btn cmn-btn addcartbutton <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_weight_id) ?>"><span><i class="fa-solid fa-cart-shopping "></i></span><?= $this->lang->line('add to cart') ?></a>
        <div class="product-detail-quentity add-cart-btns <?= $d_show ?>">
            <div class="qty-container">
                ...
                <input type="text" name="qty" value="<?= $addQuantity ?>" class="input-qty qty" data-product_id="<?= $value->prod_id ?>" data-weight_id="<?= $value->product_weight_id ?>">
