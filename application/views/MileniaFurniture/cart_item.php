...
<section class="shop-cart-seciton p-100">
    <div class="container">
        <div class="row">
            <div class="col-xxl-8 col-xl-8 col-lg-12 col-md-12 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0"
                data-wow-offset="0">
                <div class="cart-product-detail">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="cart-price-text cart-price">
                                            ...
                                            <span
                                                class="disc-throw <?= ($value['discount_per'] > 0) ? '' : ' d-none' ?>"><?= $this->siteCurrency . ' ' . $value['product_price'] ?></span>
                                        ...
                                        <div class="product-detail-quentity">
                                            <div class="qty-container">
                                                <button id="counter-decrement"
                                                    class="decrement qty-btn-minus cart-qty-minus_c"
                                                    data-product_weight_id="<?= $value['product_weight_id'] ?>"
                                                    type="button"><i class="fa-solid fa-minus"></i></button>
                                                <input id="counter-value" type="text" name="qty"
                                                    value="<?= $value['quantity'] ?>"
                                                    class="input-qty value qty quantity-counter"
                                                    data-product_id="<?= $value['product_id'] ?>"
                                                    data-weight_id="<?= $value['weight_id'] ?>" readonly />
                                                <button id="counter-increment"
                                                    class="increment qty-btn-plus cart-qty-plus_c"
                                                    data-product_weight_id="<?= $value['product_weight_id'] ?>"
                                    ...
                                    <td>
                                        <div class="cart-price-text cart-cross">
                                            ...
                                            <input type="hidden" class="total"
                                                value="<?= number_format((float)$calculation_price, 2, '.', '') ?>">
                                            <a href="#" class="removeCartItem"
                                                data-product_id="<?= $value['product_id'] ?>"
                                                data-product_weight_id="<?= $value['product_weight_id'] ?>"
                                                data-weight_id="<?= $value['weight_id'] ?>"><i
                            ...
                            <tbody class="product-tables">
                                <tr>
                                    ...
                                    <td>
                                        <div class="cart-price-text cart-price">
                                            <span
                                                class="disc-throw <?= ($value->discount_per > 0) ? '' : ' d-none' ?>"><?= $this->siteCurrency . ' ' . $value->price ?></span>
                                            <h3><?= $this->siteCurrency . '' . number_format((float)$value->discount_price, 2, '.', '') ?>
                                            </h3>
                                        </div>
                                    </td>
                                        ...
                                        <div class="product-detail-quentity">
                                            <div class="qty-container">
                                                ...
                                                <input id="counter-value" type="text" name="qty"
                                                    ...
                                                    data-weight_id="<?= $value->weight_id ?>" readonly />
                                                <button id="counter-increment"
                                                    class="qty-btn-plus increment cart-qty-plus_c" type="button"
                                                    data-product_weight_id="<?= $value->product_weight_id ?>"><i
                    ...
                    <div>
                        <button type="button" class="lg-btn clear-btn" data-bs-toggle="modal"
                            data-bs-target="#exampleModal"><?= $this->lang->line('clear cart') ?></button>
                    </div>
                </div>
            </div>
            <div class="col-xxl-4 col-xl-4 col-lg-12 col-md-12 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="0"
                data-wow-offset="0">
                ...
                <a href="<?= base_url() . 'checkout' ?>"
                    class="proceed-checkout-btn"><?= $this->lang->line('Proceed to checkout') ?></a>
            </div>
        </div>
    </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xxl-12 xol-xl-12 xol-lg-12 text-center">
        ...
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= base_url() . 'home' ?>home"><?= $this->lang->line('home') ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><?= $this->lang->line('Shop Cart') ?>
            </li>
          </ol>
        </nav>
