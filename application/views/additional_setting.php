    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/dashboard'; ?>">Home</a> / Cart Minimum Value <?php if ($result['id'] != '') {
                                                                                                                                                                        echo "Update";
                                                                                                                                                                    } else {
                                                                                                                                                                        echo "Add";
                                                                                                                                                                    } ?></a></li>
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    ...
                                    <input type="submit" class="btn btn-info pull-right margin_top_label" value="<?php echo $btn . 'Cart Minimum Value'; ?>" name="submit">
                                </div>
                            </div>
                    </form>
                </section>
