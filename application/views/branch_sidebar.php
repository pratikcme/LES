...
<li class="sub-menu" style="display: 'none'">
    ...
    <ul class="sub">
        ...
        <li <?php echo ($this->uri->segment(2) == 'parked_sell_list') ? 'class="active"' : ''; ?>> <a href="<?php echo base_url() . 'sell_development/parked_sell_list/'; ?>">Parked Sell</a>
        </li>
...
<li class="sub-menu" style="display: none;">
    ...
    <ul class="sub">
        ...
        <li <?php if (
            ...
            ) { ?> class="active" <?php } ?>><a href="<?php echo base_url() . 'report/index/'; ?>">Payment
                Reports</a>
        </li>
        <li <?php if (
