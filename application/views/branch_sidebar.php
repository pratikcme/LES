<<<<<<<<< Temporary merge branch 1 <li class="sub-menu" style="display: ''">
...
>>>>>>>>> Temporary merge branch 2
        ...
        <span>Sell</span>
            ...
            <ul class="sub">
                ...
                <<<<<<<<< Temporary merge branch 1 <li <?php echo ($this->uri->segment(2) == 'parked_sell_list') ? 'class="active"' : ''; ?>> <a href="<?php echo base_url() . 'sell_development/parked_sell_list/'; ?>">Parked Sell</a>
        </li>
        =========
        ...
        <li class="sub-menu" style="display: none;">
            ...
            <ul class="sub">
                <li <?php if (
                    ...
                    ) { ?> class="active" <?php } ?>><a href="<?php echo base_url() . 'stock_control/view_stock_control_list'; ?>">Stock Control</a>
                </li>
                <li <?php if (
        ...
        <li class="sub-menu" style="display: none;">
            ...
            <ul class="sub">
                ...
                <li <?php if (
                    ...
                    ) { ?> class="active" <?php } ?>><a href="<?php echo base_url() . 'report/inventory_reports/'; ?>">Inventory Reports</a>
                </li>
            </ul>
        </li>
        <!-- <li class="sub-menu" style="display: none;">
    ...
    <ul>
        ...
        <li>
            <a class="<?php if ($this->uri->segment(1) == 'product' && $this->uri->segment(2) == 'product_list' || $this->uri->segment(2) == 'product_profile' || $this->uri->segment(2) == 'product_weight_list' || $this->uri->segment(2) == 'product_weight_profile' || $this->uri->segment(2) == 'product_image_list') { ?> active <?php } ?>" href="<?php echo base_url() . 'product/product_list/'; ?>">
