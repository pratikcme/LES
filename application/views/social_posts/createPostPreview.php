...
<body>
    <div class="main" id="postprev">
        <div class="logo" style="background-color: <?= ($newColor != "") ? $newColor : "" ?>;">
            ...
            <svg id="logocorner" width="107" height="107" viewBox="0 0 107 107" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="footer">
                ...
                <div class="contact-us-by">
                    ...
                    <?php if ($detail_set == 'all' || $detail_set == 'contact_web_social' || $detail_set == 'contact_web') { ?>
                        <div class="contact-us-wrp">
                            <div class="icon">
                                <svg id="" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
