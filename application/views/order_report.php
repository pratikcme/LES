                                ...
                                <div class="panel-body">
                                    <div class="adv-table">
                                        <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                            <table class="display table table-bordered table-striped dataTable" id="example_order_report" aria-describedby="example_info">
                                                ...
                                                if (!empty($report)) {
                                                    ...
                                                    foreach ($report as $value) { ?>
                                                        <thead>
                                                            <tr role="row">
                                                                <th class="sorting text-center" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="3" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;"><?= ++$i . ' - ' . $value->name ?>
                                                                </th>
                                        ...
                                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                            ...
                                            style="width: 200px;">Total
                                                        ...
                                                        <tbody role="alert" aria-live="polite" aria-relevant="all">
                                                            <td class="sorting text-center" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Varient
                                                            </td>
                                                            <td class="sorting text-center" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Quantity
                                                            </td>
                                                            <td class="sorting text-center" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Total
                                                            </td>
                                                ...
                                                <?php } else { ?>
                                                    <div style="display: flex;align-items: center;justify-content: center;">
                                                        <h3 style="font-weight:bolder;">No Record found</h3>
                                                    </div>
                                                <?php } ?>
                                            </table>
                                        </div>
