    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'index.php/admin/dashboard'; ?>">Home</a> / Users </a>
                    </li>
                </ul>
                <!--breadcrumbs end -->
            </div>
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="users_table" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">First Name
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Last Name
                                            </th>
                                        ...
                                        <?php foreach ($user_result as $result) { ?>
                                            <tr class="gradeX odd">
                                                ...
                                                <td class="hidden-phone sorting_1">
                                                    <?php echo   $result->country_code . $result->phone; ?></td>
                                                ...
                                                <a href="javascript:;"
                                                    onclick="single_delete(<?php echo $result->id; ?>)"
                                                    class="btn btn-danger btn-xs"><i class="fa fa-trash-o "></i></a>
                                                <a href="<?php echo base_url() . 'index.php/admin/user_address_list?user_id=' . $this->utility->encode($result->id); ?>"
                                                    class="btn btn-primary btn-xs">Address</a>
                                            </td> -->
                                            </tr>
                                        <?php } ?>
                                    </tbody>
