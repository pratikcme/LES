        ...
        <div class="row">
            <div class="col-xxl-7 col-xl-7 col-lg-6 col-md-6">
                <div class="fill-detali-part">
                        ...
                        <div class="main-accordion">
                            ...
                            <div class="accordion-content accordion-content-3">
                                ...
                                <div class="new-address text-end">
                                    <button type="button"
                                        class="new-add"><?= $this->lang->line('Add new address') ?></button>
                                </div>

                                <form method="post" id="RegisterForm"
                                    action="<?= base_url() . 'users_account/users/add_address' ?>" class="ship-address"
                                    autocomplete="off">
                                    <div class="text-end">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <label for="text"
                                                class="form-label"><?= $this->lang->line('Mobile number') ?><span>*</span>
                                            </label>
                                        ...
                                        <div class="col-lg-12">
                                            <label for="add"
                                                class="form-label"><?= $this->lang->line('Location') ?><span>*</span>
                                            </label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="select-box">
                                                <label for="country"
                                                    class="form-label"><?= $this->lang->line('Country') ?>
                                                    <span>*</span>
                                                </label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="select-box">
                                                <label for="pincode"
                                                    class="form-label"><?= $this->lang->line('pincode') ?><span>*</span>
                                                </label>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="select-box">
                                                <label for="address"
                                                    class="form-label"><?= $this->lang->line('Address') ?><span>*</span>
                                                </label>
                                    ...
                                    <form class="time-wrapper">
                                        ...
                                        <div class="form-check">
                                            <input class="time_slot_checked form-check-input" type="radio"
                                                id="<?= 'time' . $key ?>" name="time_slot" value=" <?= $value->id ?>"
                    ...
                    <button type="button" class="btn verify-btn d-none" data-bs-toggle="modal"
            ...
            <div class="col-xxl-5 col-xl-5 col-lg-6 col-md-6">
                <div class="checkout-order-detils">
                    ...
                    <div class="coupon-code-wrapper d-none">
                        <img src="<?= $this->theme_base_url ?>/assets/images/check-out-tag-img.png" alt=""
                    ...
                    <div class="our-secure-product">
                        <div class="secure-product-wrapper">
                            <div class="icon">
                                ...
                                <svg id="Layer-2" data-name="Layer-2" xmlns="./assets/images/ShieldCheck.svg"
                        ...
                        <div class="secure-product-wrapper">
                            <div class="icon">
                                ...
                                <svg id="Layer-2" data-name="Layer-2" xmlns="./assets/images/Medal.svg"
...
<!-- Modal -->
<div class="modal fade otp-popup mobileModal" id="mobileModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
