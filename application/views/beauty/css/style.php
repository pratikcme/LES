...
if ($_SERVER['SERVER_NAME'] == 'localhost'  || $_SERVER['SERVER_NAME'] == 'stagging.launchestore.com' ||  $_SERVER['SERVER_NAME'] == 'zumkha.com' || $_SERVER['SERVER_NAME'] == 'www.zumkha.com') {
    ...
    $listing2HeaderBg = "rgba(251, 79, 180, 0.1)";
...
<style>
    :root {
        ...
        /* / ------fonts--- / */
        --BeVietnamPro-Black: 'BeVietnamPro-Black';
        --BeVietnamPro-Bold: 'BeVietnamPro-Bold';
        --BeVietnamPro-ExtraBold: 'BeVietnamPro-ExtraBold';
        ...
        --PinyonScript-Regular: 'PinyonScript-Regular';
        ...
        --card-text-secondary: <?= $cardTextSecondary ?>;
        ...
        --listing-filter-icon-bg: <?= $listingFilterIconBg ?>;
        ...
        /*  login-page-color---  */
        --login-title-color: <?= $loginTitleColor ?>;
        --login-pera-color: <?= $loginPeraColor ?>;
        ...
        --right-contact-wrapper-bg: <?= $rightContactWrapperBg  ?>;
