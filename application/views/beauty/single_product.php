                ...
                <div class="tab-content" id="myTabContent">
                    ...
                    <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="review_count">
                        ...
                        <div class="my-review-wrapper"
                            style="height :<?= (count($product_review) == 0) ? 'auto' : '100%' ?>">
                            <!-- ----review-content--- -->
                            <div class="review-content">
                                <div class="left-content">
                                    ...
                                    <div class="notranslate">
                                        <h3><strong
                                                id="avgRating"><?= (is_nan($rat)) ? 0 : $rat ?></strong><span>/5</span>
                                        </h3>
                                    </div>
                                    <div>
                                    ...
                                    <div class="rewiew-wrapper">
                                        ...
                                        <div class="review-right">
                                            <div class="review-right-top">
                                                <span class="number-star">5 <span><i
...
<div class="modal fade my-review-modal" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="reviewForm" class="modal-body" method="POST"
                ...
                <div class="rating-box">
                    ...
                    <textarea name="comment" cols="30" rows="10" class="w-100 ps-2 pt-2"
                        placeholder="Your Comments"></textarea>
                    <div class="modal-footer">
                        <button type="submit" id="btnSubmit1"
                            class="btn cmn-btn lg-btn"><?= $this->lang->line('Submit') ?></button>
                    </div>
                </div>
            </form>
        </div>
