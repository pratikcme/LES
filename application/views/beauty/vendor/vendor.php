    ...
    <div class="container">
      ...
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item check-show active" aria-current="page">Vendor</li>
        </ol>
      </nav>
    </div>
  </section>

  <section class="vendor contact-us-section section p-100">
    <div class="container">
        <div class="row">
            ...
            <div class="vendor-main">
                 ...
                 <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <a href="" class="vendor-wrapper active">
                            <div class="circle-img"></div>
                            <div class="vendor-left">
                                <img src="<?=$this->theme_base_url?>/assets/images/vendor-img-1.png" alt="">
                            </div>
                    ...
                    <div class="vendor-btns">
                        <a href="#" class="chng-locaiton">Change Store Location</a>
                        <a href="#" class="add-cart-btn vendor-cancel">Cancel</a>
                    </div>
                 </div>
            </div>
        </div>
