                                ...
                                <div class="product-categires-part discoutn-part">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="discount-wrapper">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="id11">
                                        ...
                                        <li>
                                            <div class="discount-wrapper">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="id10">
                                                    <label class="form-check-label" for="id10"><h4>5-10%</h4></label>
                                                </div>
                                                <div class="discount-text">
                                                    <h5>35</h5>
                                                </div>
                    ...
                    <div class="product-listing-wrapper wow fadeInDown" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                        <div class="techno-check">
                            ...
                            <div href="#" class="product-wrapper card">
                                ...
                                <div class="card-body">
                                    <h3><a href="./product-details.php">Too Faced Sweet Peach Eye Palette</a></h3>
                                    <h6 class="rating-cnt">₹398.00 <span><strike>₹425.00</strike></span></h6>
                                    <div class="rating-starts">
                                        <div class="rating stars3_5">
                                            <span class="star"></span>
                    ...
                    <div class="product-listing-wrapper wow fadeInDown" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                        <div class="techno-check">
                            ...
                            <div href="#" class="product-wrapper card">
                                ...
                                <div class="card-body">
                                    <h3><a href="./product-details.php">Lakme Absolute Matte Ultimate Lip Color with Argan Oil</a></h3>
                                    <h6 class="rating-cnt">₹398.00 <span><strike>₹425.00</strike></span></h6>
                                    <div class="rating-starts">
                                        <div class="rating stars3_5">
                                            <span class="star"></span>
                    ...
                    <div class="product-listing-wrapper wow fadeInDown" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                        <div class="techno-check">
                            ...
                            <div href="#" class="product-wrapper card">
                                ...
                                <div class="card-body">
                                    <h3><a href="./product-details.php">Lakme Absolute Skin Natural Mousse Mattreal Foundation</a></h3>
                                    <h6 class="rating-cnt">₹398.00 <span><strike>₹425.00</strike></span></h6>
                                    <div class="rating-starts">
                                        <div class="rating stars3_5">
                                            <span class="star"></span>
                    ...
                    <div class="product-listing-wrapper wow fadeInDown" data-wow-duration="1s" data-wow-delay="0" data-wow-offset="0">
                        <div class="techno-check">
                            ...
                            <div href="#" class="product-wrapper card">
                                ...
                                <div class="card-body">
                                    <h3><a href="./product-details.php">Maybelline New York Fit Me Matte + Poreless Setting Spray</a></h3>
                                    <h6 class="rating-cnt">₹398.00 <span><strike>₹425.00</strike></span></h6>
                                    <div class="rating-starts">
                                        <div class="rating stars3_5">
                                            <span class="star"></span>
