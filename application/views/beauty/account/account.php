        ...
        <div class="account-details-tabs">
            <div class="details-tabs">
                ...
                <ul class="nav nav-pills" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link dashboard-tabs <?= ($action_name == '' || $action_name == 'my_account') ? 'active' : '' ?>" data-bs-toggle="pill" href="#tab-1"><?= $this->lang->line('My account') ?></a>
                    </li>
                    <li class="nav-item">
                            ...
                            <form id='ChangePass' action="<?= base_url() . 'users_account/users/account' ?>" method="post" class="get-detials-account" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="tab-save-btn">
                                        <input type="Submit" id="btnAccSubmit" value="<?= $this->lang->line('Update') ?>" />
                                    </div>
                                </div>
                            </form>
                        </div>
                                        ...
                                        <?php foreach ($wishlist as $key => $value) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    ?>
                                                    <div>
                                                        <div class="card-btn addcartbutton <?= $d_none ?>" data-product_id="<?= $this->utility->safe_b64encode($value->product_id) ?>" data-varient_id="<?= $this->utility->safe_b64encode($value->product_weight_id) ?>">
                        ...
                        <div class="myaccout-detail-tab">
                            <form id='ChangeUserPass' action="<?= base_url() . 'users_account/users/update_password' ?>" method="post">
                                <div class="row">
                                    ...
                                    <div class="tab-save-btn">
                                        <button type="submit" class="common-input-btn" id="btnChangeUserPass"><?= $this->lang->line('Change Password') ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
