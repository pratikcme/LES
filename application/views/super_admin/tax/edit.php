...
<section class="new-customer background-blue-grey">
  ...
  <div class="container">
    <div class="row">
      <form id="taxForm" method="POST" action="<?= $FormAction ?>" class="new-cust-form basic-form">
        <div class="invoice-title border-grey">
          <h3 class="mb-0"><span><i class="far fa-file-alt"></i></span> Edit Tax</h3>
        </div>
        ...
        <div class="row mt-5">
          <div class="col-lg-12">
            <div class="form-group">
              ...
              <div class="row">
                <div class="col-sm-12">
                  <input type="text" name="tax_name" class="form-control name" value="<?= $editData[0]->tax_name ?>" placeholder="Tax Name">
                </div>
              </div>
            </div>
          </div>
