...
<section class="new-customer background-blue-grey">
    ...
    <div class="container">
        <div class="row">
            <form id="theme_form" method="POST" action="<?= $FormAction ?>" class="new-cust-form basic-form"
                enctype='multipart/form-data'>
                <div class="invoice-title border-grey">
                    <h3 class="mb-0"><span><i class="far fa-file-alt"></i></span> Add Theme</h3>
                </div>
                <input type="hidden" id="theme_id" name="theme_id"
                    value="<?= isset($themeDetails) ? $themeDetails[0]->id : '0' ?>">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <input type="text" name="name" class="form-control name" id="name"
                                        ...
                                        value="<?= isset($themeDetails) ? $themeDetails[0]->name : '' ?>">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <img src="<?= base_url() . 'public/images/themes_images/' . $themeDetails[0]->image ?>"
                                        style="height:100px;width:100px;" alt="err">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="button-group">
                    <button type="submit" id="btnSubmit"
                        class="btn <?= isset($themeDetails) ? 'btn-danger' :  'btn-new'  ?> ">
