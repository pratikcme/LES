            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                href="<?php echo base_url().'admin/index'; ?>">Home</a> / Customer</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                        ...
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                              ...
                              <a href="<?php echo base_url() . 'customer/fetchDataFromTable_customer/'; ?>"
                                ...
                                <table
                                    class="display table table-bordered table-striped dataTable tab_res_errr no_dpl_blck_cls"
                                    id="example_customer" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
            ...
            <form method="post" action="<?php echo base_url() . 'customer/import'; ?>" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <a href="<?php echo base_url() . 'customer/downloadCSV'; ?>"
