            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                href="<?php echo base_url().'admin/index'; ?>">Home</a> / Order</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                ...
                <section class="panel">
                    ...
                    <div class="panel-body">
                        <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="from_date" class="margin_top_label">From Date :<span class="required"
                                            aria-required="true"> </span></label>
                                    <input name="from_date" id="from_date"
                                        class="form-control form-control-inline input-medium default-date-picker "
                                        size="16" type="text" required="" placeholder="Select Date" autocomplete="off">
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="to_date" class="margin_top_label">To Date :<span class="required"
                                            aria-required="true"> </span></label>
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="form-group">
                                    <label for="to_date" class="margin_top_label">Order Staus :<span class="required"
                                            aria-required="true"></span></label>
                        ...
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            <input type="button" class="btn btn-danger pull-right margin_top_label" id="reload"
                                value="Reset">
                            &nbsp
                            <input type="button" class="btn btn-info pull-right margin_top_label" id="Search"
                                value="Search">
                        </div>
                    </div>
                    <div class="panel-body">
                        <div class="adv-table">
                            ...
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example_order"
