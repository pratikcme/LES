    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/index'; ?>">Home</a> / <a href="<?php echo base_url() . 'delivery_charge/'; ?>"> Delivery Charge </a>
                            / Delivery
                            Price Range Charge</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">Delivery Price Range Charge For
                        [<?= ($range_data[0]['start_range']) . ' - ' . ($range_data[0]['end_range']) ?>](Km)
                    </header>
                        ...
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'delivery_charge/delivery_charge_variants_addForm/' . $this->utility->encode($range_id) ?>" class="btn btn-primary">Add Delivery Price Range Charge </a>
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Start Price Range
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">End Price Range
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Delivery Charge
                                            </th>
                                            ...
                                            foreach ($range_variants_list as $result) { ?>
                                                ...
                                                <a href="<?php echo base_url() . 'delivery_charge/delivery_charge_variants?id=' . $this->utility->encode($result['id']); ?>"
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="<?php echo base_url() . 'delivery_charge/delivery_charge_variant_edit/' . $this->utility->encode($range_id)  . '/' . $this->utility->encode($result['id']); ?> " class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                                    </td>
                                                </tr>
                                            <?php $i++;
                                            }
    ...
    function single_delete(value) {
        bootbox.confirm("Are you sure you want to delete ?", function(confirmed) {
            if (confirmed == true) {
                ...
                $.ajax({
                    type: 'post',
                    url: '<?php echo base_url() . 'delivery_charge/delivery_charge_variant_delete'; ?>',
                    data: {
                        id: id
                    },
