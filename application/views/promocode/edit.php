            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                ...
                                href="<?php echo base_url() . 'banners'; ?>">List</a> /Add </a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                    ...
                    <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?= $FormAction ?>">
                        ...
                        <div class="panel-body">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 padding-zero">
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="<?php echo @$editData[0]->name; ?>" id="name"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="max_cart" name="max_cart" class="form-control"
                                                value="<?php echo @$editData[0]->max_cart; ?>">
                                            <label for="max_cart" style="color: red"
                                                class="error"><?php echo @form_error('max_cart'); ?></label>
                                        </div>

                                        <div class="form-group">
                                            <label for="percentage">Percentage</label>
                                            <input type="number" id="percentage"
                                                value="<?php echo @$editData[0]->percentage; ?>" name="percentage"
                                                class="form-control">
                                            <label for="percentage" style="color: red" class="error"> </label>
                                        </div>
                                        <div class="form-group">
                                            <label for="max_use">Max Allowed</label>
                                            <input type="text" value="<?php echo @$editData[0]->max_use; ?>"
                                                id="max_use" name="max_use" class="form-control">
                                ...
                                <div class="col-md-6 col-sm-12 col-xs-12 padding-zero">
                                    <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="min_cart"
                                                value="<?php echo @$editData[0]->min_cart; ?>" name="min_cart"
                                                class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="start_date"
                                                value="<?php echo @$editData[0]->start_date; ?>" name="start_date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="date" id="end_date"
                                                value="<?php echo @$editData[0]->end_date; ?>" name="end_date"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="notes"
                                                class="form-control"><?= $editData[0]->notes; ?></textarea>
                                        </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="<?= base_url() . 'promocode_manage' ?>"
                                    style="float: right; margin-right: 10px;" id="delete_user"
                                    class="btn btn-danger">Cancel</a>
                                <input type="submit" class="btn btn-info pull-right margin_top_label" value="Update"
