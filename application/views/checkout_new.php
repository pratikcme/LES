                    ...
                    <?php if ($register_result[0]->type == '1') { ?>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="cmn-bg h-auto quick-keys-title">
                                ...
                                <div class="set-up-quick-keys-btn-wrap pb-0">
                                    ...
                                    <button type="button" class="border-btn" id="quick_keys" data-toggle="modal" data-target="#quick-keys">
                                        Set Up Quick Keys
                                    </button>
                                </div>
                            </div>
                            <div class="">
                                <div class="quick-keys-wrap">
                                    <?php foreach ($IsPosMostLike as $key => $value) : ?>
                                        ...
                                        <div class="quick-view-wrap add_quick_product" data-product_id="<?= $value->product_id ?>" data-pw_id="<?= $value->id ?>">
                                            <p><?= $value->name ?></p>
                                            ...
                                            <span class="delete-wrap remove_quick_list_item" data-pw_id="<?= $value->id ?>">
                                                <img src="<?= base_url() ?>/public/admin_product_page_assets/images/delete.svg" alt="delete" class="deleteIcon">
                                            </span>
                                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <form method="post" action="<?php echo base_url() . 'sell_development/order_checkout/'; ?>" id="paypal_form" class="paypal" name="checkout_sell">
                                ...
                                <input type="hidden" name="hidden_discount_total" id="hidden_discount_total" value="<?= $total_savings ?>">
                                ...
                                <input type="hidden" name="shopping_based_discount" value="<?= $shopping_based_discount ?>" id="shopping_based_discount">
                                <input type="hidden" name="isShow" id="isShow" value="<?= $isShow ?>">
                                <input type="hidden" name="base_url" id="base_url" value="<?= base_url() ?>">
                                <input type="hidden" name="applied" id="applied" value="false">
                                <input type="hidden" name="parked_order_id" id="parked_order_id" value="<?= $parked_order_id ?>">
                                ...
                                <div class="top justify-content-end">
                                    <div class="button-top d-flex justify-content-end">
                                        ...
                                        <button class="border-btn d-inline-block" id="parked_sell" name="parked_sell" value="Park Sale">Park
                                            Sale</button>

                                        <button type="button" class="border-btn d-inline-block discard_class" id="<?= (isset($parked_order_id) && !empty($parked_order_id)) ? 'discard_parked_sell' : 'discard_sell' ?>">Discard
                                            Sale</button>

                                    </div>
                                </div>
                                <div id="myDropdown" class="dropdown-content">
                                    <ul class="retrive_sale_parked">
                                        <li>
                                            <h5>Parked Sale</h5>
                                        </li>
                                        <?php
                                ...
                                <div class="cmn-bg mt-3">
                                    <div class="input-box add-customer">
                                        ...
                                        <input type="text" placeholder="Add Customer" name="add_customer" autocomplete="off" id="add_customer" />
                                    </div>
                                    <div id="message">
                                    </div>
                                    ...
                                    <div class="total-wrap">
                                        ...
                                        <input type="hidden" name="park_gst_amt" id="park_gst_amt" value="0">
                                        <span class="" id="promo_err"></span>
                                        <div class="subtotal-wrap">
                                            <div>
                                                <p>Products Subtotal</p>
                                                <p><?= $currency . ' '; ?>
                                                    <span class="subtotal" id="subtotal"><?= number_format((float) $subtotal, 2, '.', '') ?></span>
                                                </p>
                                            </div>
                                            <!-- new -->
                                            ...
                                            <div id="cart_based_item">
                                                ...
                                                <p>- (<span id="shopping_based_discountPercentage">
                                                    ...
                                                    <span id="shopping_based_discount_amount"><?= $currency . ' '; ?><?= number_format((float) $shopping_based_discount, 2, '.', '') ?></span>
                                                </p>
                                            </div>
                                        ...
                                        <div class="total-payment-wrap">
                                            ...
                                            <button class="btn-apply total-main">
                                                <span>Pay</span>
                                                <span><?= $currency . ' '; ?><span id="total_pay"><?= number_format((float) $subtotal, 2, '.', '') ?></span></span>
                                            </button>
                                        </div>
                                    </div>
                                </div>
