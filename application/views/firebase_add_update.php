            ...
            <div class="panel-body">
              <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                  ...
                  <div class="form-group">
                    <label for="checkout_line">Checkout page line</label>
                    <input type="text" id="checkout_line" name="checkout_line" class="form-control" value="<?php echo @$getData[0]->checkout_line != '' ? $getData[0]->checkout_line : @set_value('checkout_line'); ?>">
                    <label for="checkout_line" class="error"><?php echo @form_error('checkout_line'); ?></label>
                  </div>
                  <!-- <div class="form-group">
