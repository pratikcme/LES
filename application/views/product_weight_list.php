            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                href="<?php echo base_url() . 'admin/index'; ?>">Home</a> / <a
                                href="<?php echo base_url() . 'product/product_list' ?>">Product </a> / Product
                            Variants</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    <header class="panel-heading">
                        Variants<?= (isset($getNameOfProduct[0]->name)) ? ' Of ' . ucfirst($getNameOfProduct[0]->name) : ''; ?>
                    </header>
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'product/product_weight_profile?product_id=' . $this->utility->encode($product_id); ?>"
                                        class="btn btn-primary">Add Product Variant</a>
                                ...
                                <table class="display table table-bordered table-striped dataTable"
                                    id="example_product_weight_id" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                        ...
                        <div class="asd  text-center col-lg-12"> <a
                                href="<?php echo base_url() . 'product/product_list'; ?>" class="btn btn-primary"
                                style="margin-top: 0px;" id="as">Back</a></div>
                    </div>
                </section>
            </div>
        </div>
        ...
        if (confirmed == true) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    var a = data.names;
                    if (data.status == 1) {
                        bootbox.alert("Product variant has been deleted successfully.",
                            function() {
                                window.location.reload(true);
                            });
                    } else if (data.status == 5) {
                        bootbox.alert("The product '" + a +
                            "', is maped with order. Please deselect it and try again.",
                            function() {});
                    } else {
