            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                href="<?php echo base_url() . 'admin/index'; ?>">Home</a> / Customer Group</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                        ...
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <div class="panel-body" style="float: right">
                                    <a href="#myModal" class="btn btn-primary btn-lg" data-toggle="modal">Add Customer
                                        Group</a>
                                </div>

                                <table class="display table table-bordered table-striped dataTable"
                                    id="example_group_list" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                ...
                                                style="width: 305px;">Name</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Date</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;"></th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                                        ...
                                        <tr class="gradeX odd">
                                            ...
                                            <td class=""><a
                                                    href="<?php echo base_url() . 'customer/group_customer_view?id=' . $group->id; ?>"
                                                    class="btn btn-primary btn-xs">View Customers</a>
                                            </td>
                                            <td class="">
                                                <a href="javascript:;" onclick="type_update(<?php echo $group->id; ?>)"
                                                    data-toggle="modal" class="btn btn-primary btn-xs"><i
                                                        class="fa fa-pencil"></i></a>
                                                <a href="javascript:;"
                                                    onclick="single_delete(<?php echo $group->id; ?>)"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="<?php echo base_url() . 'customer/update_group'; ?>" id="update_customer_form">
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-primary submitBtn" value="Update Customer Group"
                        name="submit" />
                </div>
            </form>
        </div>
