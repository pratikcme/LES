...
<body class="login-body" style="background: url('<?php echo base_url() . "public/images/back_img.jpg"; ?>')">
    <div class="container">
        ...
        <form class="form-signin" enctype="multipart/form-data"
            action="<?php echo base_url() . 'vendor/new_vendor_register/'; ?>" method="post" id="vendor_form">
            ...
            <div class="login-wrap" style="">
                <div class="form-group">
                    <label for="" class="control-label col-md-3">Domain Name :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="text" name="domain_name" id="domain_name" placeholder="Enter domain url"
                        autocomplete="off" class="form-control placeholder-no-fix"
                        value="<?php echo set_value('domain_name'); ?>">
                    <?php echo form_error('domain_name'); ?>
                </div>
                <div class="form-group">
                    <label for="" class="control-label col-md-3">Enter Shop Name :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="text" name="name" id="name" placeholder="Shop Name" autocomplete="off"
                        class="form-control placeholder-no-fix" value="<?php echo set_value('name'); ?>">
                    <?php echo form_error('name'); ?>
                </div>

                <div class="form-group">
                    <label for="" class="control-label col-md-3">Enter Shop Owner Name :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="text" name="ownername" id="ownername" placeholder="Shop Owner Name" autocomplete="off"
                        class="form-control placeholder-no-fix" value="<?php echo set_value('ownername'); ?>">
                    <?php echo form_error('ownername'); ?>
                </div>
                <div class="form-group">
                    <label for="" class="control-label col-md-3">Store Type :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                ...
                <div class="form-group">
                    <label for="" class="control-label col-md-3">Shop Image :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="file" name="image" placeholder="Shop Image" id="img"
                        value="<?php echo set_value('image'); ?>">
                    <?php echo form_error('file'); ?>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Enter Email Address :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="text" id="email" name="email" placeholder="Email Address" autocomplete="off"
                        class="form-control placeholder-no-fix" value="<?php echo set_value('email'); ?>">
                    <?php echo form_error('email'); ?>

                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Enter Password :<span class="required" aria-required="true"> *
                        </span>
                    </label>
                    <input type="password" id="password" name="password" placeholder="Password"
                        autocomplete="new-password" class="form-control placeholder-no-fix"
                ...
                <div class="form-group">
                    <label class="control-label col-md-3">Enter Mobile :<span class="required" aria-required="true"> *
                        </span>
                    </label>
                    <input type="text" name="mobile" placeholder="Mobile" autocomplete="off"
                        class="form-control placeholder-no-fix" value="<?php echo set_value('mobile'); ?>"
                        maxlength="15" onkeypress="validate(event)">
                    <?php echo form_error('mobile'); ?>
                </div>
                <div class="form-group">
                    <label class="control-label col-md-3">Subscription Plan :<span class="required"
                            aria-required="true"> * </span>
                    </label>
                    <input type="text" class="form-control" name="subscription_plan" readonly
                        value="<?php echo $subs_charge[0]->value; ?> ">
                    <?php echo form_error('subscription_plan'); ?>
                </div>


                <div class="form-group">
                    <label class="control-label col-md-3">Enter Address :<span class="required" aria-required="true"> *
                        </span></label>
                ...
                <div class="form-group row ">
                    <div class="col-md-11">
                        <label class="control-label col-md-3">Enter Location :<span class="required"
                                aria-required="true"> * </span>
                        </label>
                        <input type="text" id="departure_address" onFocus="initAutocomplete('departure_address')"
                            class="form-control" placeholder="Location" name="location" maxlength="255"
                            value="<?php echo set_value('location'); ?>">
                        <?php echo form_error('location'); ?>
                    </div>
                    <div class="col-md-1">
                        <a class="display_map" href="javascript:;" onclick="initialize('departure');"
                            title="Pick from Map"><img src="http://maps.google.com/mapfiles/ms/icons/blue-dot.png"></a>
                    </div>
                ...
                <div style="height: 20px;">
                    <a href="<?php echo base_url() . 'admin/login'; ?>"
                        style="float: right; margin-right: 10px; color: white;" id="delete_user"
                        class="btn btn-danger">Cancel</a>
                    <input class="btn btn-success" style="float: right; margin-right: 30px;" type="submit"
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyB-nS3x_SS2JjPSrbq772nwf4QEHRSK1y4&v=3.exp&libraries=places">
    </script>
</body>
<script type="text/javascript">
// setTimeout(function(){
