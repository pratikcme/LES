...
<section id="main-content">
    <form role="form" method="post" action="<?php echo base_url().'delivery/update_delivery/';  ?>" name="service_form"
                        ...
                        <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                            <div class="customer">
                                ...
                                <a href="<?php echo base_url().'index.php/admin/dashboard'; ?>" data-toggle='modal'
                                    class="but btn btn-danger btn-s-xs" nam e="cancel">Cancel</a>
                                <input type="submit" name="submit" id="sbtFrm" value="Update"
                                    class="but btn btn-success btn-s-xs">
                                <?php  } ?>
                                <?php 
                         if($vendor_id != 0){ ?>
                                <div class="form-group row ">
                                    <div class="col-md-11">
                                        ...
                                        <input type="text" id="departure_address"
                                            ...
                                            value="<?php if(isset($app_result['location'])){ echo $app_result['location']; }else{ echo set_value('location'); } ?>"
                                    ...
                                    <input type="hidden" id="departure_latitude" name="latitude" placeholder="Latitude"
                                        value="<?php if(isset($app_result['latitude'])){ echo $app_result['latitude']; }else{ echo set_value('latitude'); } ?>" />
                                    <input type="hidden" id="departure_longitude" name="longitude"
                                        placeholder="Longitude"
                                        value="<?php if(isset($app_result['longitude'])){ echo $app_result['longitude']; }else{ echo set_value('longitude'); } ?>" />
                                </div>
                                <?php 
                         }  ?>
                            </div>
                            ...
                            <div class="customer padding_dropdown margin_btm">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea rows="4" cols="50" name="address" placeholder="Address"
                                        ...
                                        value=""><?php if(isset($app_result['address'])){ echo $app_result['address']; }else{ echo set_value('address'); } ?></textarea>
                                ...
                                <div class="img img_show" id="image_<?php echo $value->id; ?>"
                                    style="float: left; margin-right: 10px; margin-bottom: 20px;">
                                    <?php if($vendorimg!='' && file_exists('public/images/vendor_shop/'.$vendorimg)){ ?>
                                    <img src="<?php echo base_url().'public/images/vendor_shop/'.$vendorimg; ?>"
