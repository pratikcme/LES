...
#add-prod-list::-webkit-scrollbar-track {
    -webkit-box-shadow: inset 0 0 6px rgba(0, 0, 0, 0.3);
    border-radius: 10px;
    background-color: #F5F5F5;
}

#add-prod-list::-webkit-scrollbar {
    width: 5px;
    background-color: #F5F5F5;
}

#add-prod-list::-webkit-scrollbar-thumb {
    border-radius: 10px;
...
.category-list.add_quick_product h4 {
    padding: 0 !important;
    margin: 0 !important;
}

.category-list.add_quick_product p {
    padding: 0 !important;
    margin-top: 7px;
    margin-bottom: 0;
    text-align: left;
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                ...
                                <div class="search-wrapper">
                                    <div class="search-bar">
                                        ...
                                        <input type="text" class="form-control" id="search_prod"
                           ...
                           <div class="form-group">
                                ...
                                <div class="quick-layout-wrapper no-quick-keys">
                                    ...
                                    <div class="select_category_item">
                                        ...
                                        <div class="quick-view">
                                            ...
                                            <div class="category-list add_quick_product"
                                                ...
                                                <a href="javascript:">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h4><?= $value->name ?></h4>
                                                        <!-- <h2 style="text-decoration: line-through;"><?= $value->price ?> -->
                                                        </h2>
                                    ...
                                    <p>create your custom quicks keys for most popular,product and speed up checkout
                                    </p>
                                    <div style="text-align:center;margin-top: 15px;">
                                        <button type="button" class="btn btn-info" id="quick_keys" data-toggle="modal"
                                            data-target="#quick-keys">Set Up Quick Keys</button>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                <form method="post"
                                    ...
                                    <input type="hidden" name="shopping_based_discount"
                                        value="<?= $shopping_based_discount ?>" id="shopping_based_discount">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4 padd_lft_0">
                                                <div class="check_items dropdown">
                                                    <h4 class="btn items_count dropbtn" onclick="myFunction()"><i
                                                            class="fa fa-share vd-mr1"></i> Retrieve sale</h4>
                                                    <span></span>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-4">
                                                <button type="button" class="btn items_count"
                                                    id='discard_parked_sell'>discard sale</button>
                                            </div>
                                            <!--
                                            To Repark    
                                            <a href="<?= $_SERVER['HTTP_REFERER']; ?>">Go
                                                Back</a> -->
                                            <?php } else { ?>
                                            <div class="col-lg-4 col-md-4 col-sm-4"
                                                style="<?= (empty($order_temp_result)) ? 'display:none' : 'display:block' ?>">
                                                <button type="submit" class="btn items_count submit" id="parked_sell"
                                                    name="parked_sell" value="Park Sale">park sale</button>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-4"
                                                style="<?= (empty($order_temp_result)) ? 'display:none' : 'display:block' ?>">
                                        ...
                                        <div class="brder">
                                            <div class="create_cutomer">
                                                <!-- <a href="<?php echo base_url() . 'customer/customer1'; ?>">Create
                                                 New Customer</a> -->
                                                <input type="text" class="form-control" name="add_customer"
                                                    id="add_customer" placeholder="Add a customer">
                                                <div id="message">
                                            ...
                                            <div class="product-list-container">
                                                ...
                                                <div class="product-list-wrapper old_list">
                                                    ...
                                                    <div class="product-quantity-detail-wrapper">
                                                        ...
                                                        <div class="product-quantity-detail">
                                                            <label for="">dis</label>
                                                            <input type="number" readonly min="0" max="99"
                                                        ...
                                                        <div class="total-wrapper">
                                                            ...
                                                            <i class="fa fa-trash revomeRecord" aria-hidden="true"
                                                                data-order_tempId="<?= $value->id ?>"
                                                                data-isParked="<?= (isset($parked_order_id) ? $parked_order_id : '0') ?>"></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <?php } ?>
                                            ...
                                            <div class="note_of_sale">
                                                <ul>
                                                        ...
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total_digit">
                                                                ...
                                                                <!-- <div class="add_rupees"><input type="number"
                                                                            ...
                                                                            id="disc_percentage"
                                                                    value="<?php if (isset($parked_order_id)) {
                                                                                echo $order_temp_result[0]->order_discount;
                                                                            } ?>">
                                                                    <label id="error"
                                                    ...
                                                    <li id="cart_based_item">
                                                        ...
                                                        <!-- <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total_digit">
                                                                ...
                                                                <div class="add_rupees"><input type="number" min="0"
                                                                        max="99" name="disc_percentage" placeholder="%"
                                                                        id="disc_percentage"
                                                                        value="<?php if (isset($parked_order_id)) {
                                                                                    echo $order_temp_result[0]->order_discount;
                                                                                } ?>">
                                                                ...
                                                                <?= $currency . ' '; ?> <span
                                                                    id="discount_total"><?= number_format((float)$total_discount, 2, '.', '')
                                                                                        ?></span>
                                                            </div>
                                                         </div> -->
                                                        ...
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total">
                                                                <p>Cart Amount Based Discount </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total_digit">
                                                                - (<span id="shopping_based_discountPercentage">
                                                    ...
                                                    <li id="promocode_discount_item">
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total">
                                                                <p>Prmocode Discount </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total_digit">
                                                                ...
                                                                <?= $currency . ' '; ?>
                                                                <span id="promocode_discount">0.00</span>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    <li id="promocode_item"
                                                        ...
                                                        <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                            <div class="add_total_digit">
                                                                <div class="add_rupees">
                                                                    <input type="text" name="promocode" id="promocode"
                                                                        placeholder="Enter Promocode">
                                                                    <span class="error" id="promo_err"></span>
                                                                    <button id="checkPromocode" class="btn btn-primary"
                                                    ...
                                                    <div class="payment_btn">
                                                        <div>
                                                            <div class="final_btn_pay">
                                                                ...
                                                                <a href="javascript:" class="pay-btn" id="span_pay"
                                                                    onclick="">
                                                                ...
                                                                <div class="after-pay">
                                                                    <button class="submit" value="Cash"
                                                                        name="case">cash</button>
                                                                    <button class="submit" value="Credit Card"
                                                                        name="credit_card">online
                                                                        payment</button>
                                                                    <!-- use credit card orany else as online payment -->
...
$('#add_customer').on('keydown, keyup', function() {
    ...
    console.log("check", $('#message p span'))
});
