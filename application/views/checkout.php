                        ...
                        <?php if ($register_result[0]->type == '1') { ?>
                           ...
                           <div class="form-group">
                              <label for="name" class="product_header">Variants</label>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                                        <form method="post" action="<?php echo base_url() . 'sell_development/order_checkout/'; ?>" id="paypal_form" class="paypal" name="checkout_sell">
                                            ...
                                            <input type="hidden" name="hidden_discount_total" id="hidden_discount_total" value="0.00">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <?php } else { ?>
                                                        <div class="col-lg-4 col-md-4 col-sm-4" style="<?= (empty($order_temp_result)) ? 'display:none' : 'display:block' ?>">
                                                            <button type="submit" class="btn items_count submit" id="parked_sell" name="parked_sell" value="Park Sale">park sale</button>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4" style="<?= (empty($order_temp_result)) ? 'display:none' : 'display:block' ?>">
                                                            ...
                                                            <div class="product-list-wrapper old_list">
                                                                ...
                                                                <div class="product-quantity-detail-wrapper">
                                                                    <div class="product-quantity-detail">
                                                                        <label for="">Qty</label>
                                                                        <input type="number" onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" name="qnt<?= $value->id ?>" class="qunt" min="1" data-actual_discount_price="<?= number_format((float)$value->product_price, 2, '.', '') ?>" data-product_weight_id="<?= $value->product_weight_id ?>" data-temp_id="<?= $value->id ?>" value="<?= $value->quantity ?>" data-isParked="<?= (isset($parked_order_id) ? $parked_order_id : '0') ?>" inputmode="decimal">
                                                                        <span style="color: red" id="error<?= $value->id ?>"></span>
                                                                    </div>
                                                                    <div class="product-quantity-detail">
                                                                        <label for="">dis</label>
                                                                        <input type="number" min="0" max="99" name="discount<?= $value->id ?>" class="disc" data-product_weight_id="<?= $value->product_weight_id ?>" data-temp_id="<?= $value->id ?>" value="<?= $value->discount ?>" data-actual_discount_price="<?= number_format((float)$value->product_price, 2, '.', '') ?>" data-isParked="<?= (isset($parked_order_id) ? $parked_order_id : '0') ?>">
                                                                        <span style="color: red" id="error<?= $value->id ?>"></span>
                                                                    </div>
                                                                    <div class="total-wrapper">
                                                            ...
                                                            <li>
                                                                ...
                                                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                                    <div class="add_total_digit">
                                                                        ...
                                                                        <div class="add_rupees"><input type="number" min="0" max="99" name="disc_percentage" placeholder="%" id="disc_percentage" value="<?php if (isset($parked_order_id)) {
                                                                                                                                                                                                                echo $order_temp_result[0]->order_discount;
                                                                                                                                                                                                            } ?>">
                                                                            <label id="error" style="color:red;"></label>
                                                                        </div>
                                                                        <span style="color: red" id="error"></span>
                                                                        <?= $currency . ' '; ?> <span id="discount_total"><?= number_format((float)$total_discount, 2, '.', '') ?></span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <li>
                                                                ...
                                                                <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
                                                                    ...
                                                                    <label id="error"
                                                                        ...
                                                                        <?= $currency . ' '; ?><span id="total_gst"><?= number_format((float)$total_gst, 2, '.', '') ?></span>
                                                                    </div>
                                                                </div>
                                                            </li>
                                                            <!-- <li>
                                                            ...
                                                            <div class="payment_btn">
                                                                <div>
                                                                    <div class="final_btn_pay">
                                                                        ...
                                                                        <a href="javascript:" class="pay-btn" id="span_pay" onclick="">
                                                                        ...
                                                                        <div class="after-pay">
                                                                            ...
                                                                            <button class="submit" value="Credit Card" name="credit_card">online payment</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="form-group text-center">
                                <button type="submit" name="create" class="btn btn-primary create_new_cust" id="btnSubmit">Create New
                                    Customer</button>
                            </div>
                        </div>
                    </div>
