    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url().'admin/dashboard'; ?>">Home</a> / Currency  <?php if($result['id']!=''){
                            echo "Update";
                        }else{
                            echo "Add";
                    } ?></a></li>
        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    ...
                    <form role="form" method="post" action="<?php echo base_url().'setting/currency_add'; ?>" name="cart_value" id="cart_value" enctype="multipart/form-data">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                             ...
                             <input type="submit" class="btn btn-info pull-right margin_top_label" value="<?php echo $btn.'Currency Symbol'; ?>" name="submit">
                            </div>
                        </div>
                    </form>
                </section>
