...
<script class="include" type="text/javascript" src="<?php echo base_url(); ?>public/js/jquery.dcjqaccordion.2.7.js">
</script>
...
<script type="text/javascript" src="<?php echo base_url(); ?>public/assets/bootstrap-daterangepicker/moment.min.js">
</script>
<script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/moment.js/2.9.0/moment-with-locales.js">
</script>
<script type="text/javascript" src="https://cdn.rawgit.com/Eonasdan/bootstrap-datetimepicker/e8bddc60e73c1ec2475f827be36e1957af72e2ea/src/js/bootstrap-datetimepicker.js">
</script>
...
if (!empty($js)) {
    foreach ($js as $value) {
?>
        <script src="<?php echo base_url(); ?>public/admin/assets/admins/js/<?php echo $value ?>" type="text/javascript">
        </script>
<?php
    }
}
...
?>
        <script src="<?php echo base_url(); ?>public/admin/assets/tablejs/<?php echo $value ?>" type="text/javascript"></script>
<?php
    }
}
?>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#closure_summary').DataTable({
            // order: ['5', 'asc'],
            "oLanguage": {
                "sEmptyTable": "No Closure Registers List!",
                "sZeroRecords": "No Closure Registers List!",
            }
        });
