   ...
   <section class="wrapper">
      ...
      <div class="row">
         <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <!--breadcrumbs start -->
            <ul class="breadcrumb">
               <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/dashboard'; ?>">Home</a> / <a href="<?php echo base_url() . 'banners'; ?>">List</a> /Edit </a></li>
            </ul>
            <!--breadcrumbs end -->
         </div>
      </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 padding-zero">
                           <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 ...
                                 <div id='show1' class="" style="width: 150px;height: 150px; margin-top: 20px; display:<?= (@$editRecord[0]->app_banner_image != "") ? 'block' : 'none' ?>">
                                    <img id=" app_ContentImage" src="<?= base_url() . 'public/images/' . $this->folder . 'banner_promotion/' . $editRecord[0]->app_banner_image ?>" height="100%" width="100%">
                                 </div>
                              </div>
                        ...
                        <div class="col-md-6 col-sm-12 col-xs-12 padding-zero">
                           <div class="col-lg-12 col-md-6 col-sm-6 col-xs-12">
                              <div class="form-group">
                                 ...
                                 <div id='show2' class="" style="width: 150px;height: 150px; margin-top: 20px; display:<?= ($editRecord[0]->web_banner_image != "") ? 'block' : 'none' ?>">
                                    <img id="web_ContentImage" src="<?= base_url() . 'public/images/' . $this->folder . 'web_banners/' . $editRecord[0]->web_banner_image ?>" height="100%" width="100%">
                                 </div>
                              </div>
                              <label for="image" style="color: red" class="error"></label>
                              <div class="form-group">
                                 ...
                                 <select class="form-control" name="branch" id="branch">
                                    ...
                                    <<?php foreach ($branchList as $key => $value) : ?> <option value="<?= $value->id ?>" <?= ($value->id == $editRecord[0]->branch_id) ? "SELECTED" : "" ?>><?= $value->name ?></option>
                                    <?php endforeach ?>
                                 </select>
                              </div>
                              <div class="form-group">
