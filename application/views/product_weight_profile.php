            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                ...
                                href="<?php echo base_url() . 'product/product_list' ?>">Product </a> / <a
                                href="<?php echo base_url() . 'product/product_weight_list?product_id=' . $this->utility->encode($product_id) ?>">
                                Product Variant </a>/
                            <?= (isset($_GET['id']) && $_GET['id'] != '') ? 'Update' : 'Add' ?>
                        </a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    ...
                    <form role="form" method="post"
                        action="<?php echo base_url() . 'product/product_weight_add_update'; ?>"
                        name="product_weight_form" enctype="multipart/form-data" id="product_weight_form">
                        ...
                        <div class="panel-body">
                            <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                        <label for="name" class="margin_top_label">Variant :<span class="required"
                                                aria-required="true"> * </span></label>
                                        <input type="text" class="form-control margin_top_input" id="unit" name="unit"
                                            placeholder="Variant"
                                            value="<?= (isset($result)) ? $result['weight_no'] : ''; ?>">
                                    </div>
                                    <div class="form-group">
                                        <label for="weight_id" class="margin_top_label">Unit :<span class="required"
                                                aria-required="true"> * </span></label>
                                        <select class="form-control margin_top_input" id="weight_id" name="weight_id">
                                            <option value="" selected disabled>Select Unit</option>
                                            <?php foreach ($weight_result as $weight) { ?>
                                            <option value="<?= $weight->id ?>" <?php if (isset($wei_result)) {
                                                                                        echo ($wei_result['id'] == $weight->id) ? 'SELECTED' : '';
                                                                                    } ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control margin_top_input" id="package" name="package">
                                            <option value="" selected disabled>Select Package</option>
                                            <?php foreach ($package_results as $package) { ?>
                                            <option value="<?php echo $package->id; ?>" <?php if (isset($result)) {
                                                                                                echo ($result['package'] == $package->id) ? 'SELECTED' : '';
                                                                                            } ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control margin_top_input" id="quantity"
                                            ...
                                            value="<?= (isset($result)) ? $result['quantity'] : ''; ?>" min="1">
                                    </div>
                                    <!-- Dipesh -->

                                    <div class="form-group">
                                        <label for="qr_code" class="margin_top_label">Bar Code :</label>
                                        <input type="text" class="form-control margin_top_input" id="qr_code"
                                            name="qr_code" placeholder="Bar code"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label for="purchase_price" class="margin_top_label">Purchase Price :<span
                                                class="required" aria-required="true"> * </span></label>
                                        <input type="text" class="form-control margin_top_input" id="purchase_price"
                                            name="purchase_price" placeholder="Purchase Price"
                                            value="<?= (isset($result)) ? $result['purchase_price'] : ''; ?>"
                                            onchange="validate(event)">
                                    </div>
                                    <div class="form-group">
                                        <label for="name" class="margin_top_label">Maximum Retail Price (MRP) :<span
                                                class="required" aria-required="true"> * </span></label>
                                        <input type="text" class="form-control margin_top_input" id="price" name="price"
                                            placeholder="Price" value="<?= (isset($result)) ? $result['price'] : ''; ?>"
                                            onchange="validate(event)">
                                    </div>

                                    <div class="form-group">
                                        <label for="name" class="margin_top_label">Discount(%) :</label>
                                        <input type="number" class="form-control margin_top_input" id="discount_per"
                                            name="discount_per" placeholder="Discount"
                                            value="<?= (isset($result)) ? $result['discount_per'] : ''; ?>" min="0"
                                            max="100">
                                    </div>

                                    <div class="form-group">
                                        <label for="name" class="margin_top_label">Max Order Quantity :</label>
                                        <input type="number" class="form-control margin_top_input" id="max_order_qty"
                                            name="max_order_qty" placeholder="max order quamtity"
                                            value="<?= (isset($result['max_order_qty'])) ? $result['max_order_qty'] : ''; ?>"
                                            min="0" max="100">
                                    </div>

                                    <div class="form-group variantimg">
                                        <label for="name" class="margin_top_label">Image :<span class="required"
                                                aria-required="true"> * </span></label>
                                        <input type="file" accept="image/x-png,image/gif,image/jpeg" multiple="multiple"
                                            class="form-control margin_top_input" id="image" name="userfile[]"
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="img" id="image_<?php echo $value->id; ?>"
                                    style="float: left; margin-right: 10px; margin-bottom: 20px;">
                                    <a href="javascript:;" onclick="single_delete(<?php echo $value->id; ?>)"
                                        style="float: right;" class="btn btn-danger btn-xs"><i
                                            class="fa fa-trash-o "></i></a>
                                    <img src="<?php echo base_url() . 'public/images/' . $this->folder . 'product_image/' . $value->image; ?>"
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <a href="<?php echo 'product_weight_list?product_id=' . $this->utility->encode($product_id); ?>"
                                    style="float: right; margin-right: 10px;" class="btn btn-danger">Cancel</a>
                                <input type="submit" class="btn btn-info pull-right margin_top_label"
                                    value="<?= (isset($_GET['id']) && $_GET['id'] != '') ? 'Update Product Variant' : 'Add Product Variant' ?>"
                                    name="submit_frm">
                            </div>
                        </div>
                    </form>
        ...
        if (input.files) {
            ...
            for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
                    $($.parseHTML('<img height = "150" width = "200">')).attr('src', event.target
