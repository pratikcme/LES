        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/dashboard'; ?>">Home</a> / <a href="<?php echo base_url() . 'product/product_list' ?>">Product </a> / <a href="<?php echo base_url() . 'product/product_weight_list?product_id=' . $this->utility->encode($product_id) ?>">
                                Product Variant </a>/
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control margin_top_input" id="qr_code" name="qr_code" placeholder="Bar code" value="<?= (isset($result)) ? $result['qr_code'] : ''; ?>">
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group variantimg">
                                        ...
                                        <span>Image should be less then 2 MB</span>
