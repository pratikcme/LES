                            ...
                            <div class="clouser_register">
                                        ...
                                        <div class="closer_cash_part2">
                                            ...
                                            <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 res_no_padd">
                                                <div class="drawer_cash">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="summary_cash">
                                                            <input type="number" min="0" id="counted_cash"
                                                                class="form-control" placeholder="Enter Amount"
                                                                value="<?php echo ($register_result[0]->counted > 0) ? $register_result[0]->counted : "0.00"; ?>"
                                                                onkeyup="cash_summary(this.value, <?php echo $register_result[0]->id; ?>)"
                                                                inputmode="decimal">
                                                        </div>
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="summary_cash">
                                                            <p id="cash_differences"
                                                                style="<?php if (numberFormat($register_result[0]->counted - number_format((float)(float)$total + (float)$transaction, 2, '.', '')) >= 0) { ?> color: green; <?php } else { ?> color: red; <?php } ?> ">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="summary_cash">
                                                            <input type="number" class="form-control"
                                                                ...
                                                                value="<?php echo ($register_result[0]->credit_card_counted > 0) ?   $register_result[0]->credit_card_counted : "0.00"; ?>"
                                                                placeholder="Enter Amount" id="credit_card_counted"
                                                                onkeyup="credit_card_summary(this.value, <?php echo $register_result[0]->id; ?>)">
                                                        </div>
                                                        <!-- onkeypress="return (event.charCode == 8 || event.charCode == 0) ? null : event.charCode >= 48 && event.charCode <= 57" -->
                                                    </div>
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="summary_cash">
                                                            <p id="credit_card_differences"
                                                                style="<?php if (numberFormat($register_result[0]->credit_card_counted - $online_result['total']) >= 0) { ?> color: green; <?php } else { ?> color: red; <?php } ?> ">
                                                    ...
                                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                        <div class="summary_cash">
                                                            ...
                                                            <p id="total_differences"
                                                                style="<?php if (numberFormat(numberFormat($register_result[0]->counted - number_format((float)(float)$total + (float)$transaction, 2, '.', '')) + numberFormat($register_result[0]->credit_card_counted - $online_result['total'])) >= 0) { ?> color: green; <?php } else { ?> color: red; <?php } ?> ">
                                                                <?php
                                ...
                                <div class="clouser_note_type">
                                    <div class="note_create">
                                        <textarea class="form-control" id="closure_note"
                                            placeholder="Type to add a register closure note"></textarea>
                                    </div>
                                </div>
        ...
        $.ajax({
            ...
            success: function() {
                window.location.href =
                    '<?php echo base_url() . "index.php/register/close_register"; ?>';
            }
        });
    }
});
...
function cash_summary(value, id) {
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            let val1 = parseFloat($('#cash_differences').html()) + parseFloat($("#credit_card_differences")
                .html());
