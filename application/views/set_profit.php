    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/dashboard'; ?>">Home /</a><a href="<?php echo base_url() . 'vendor/vendor_accounting'; ?>"> Vendor accounting </a> /
                            Set Profit</a> </li>
                </ul>
                <!--breadcrumbs end -->
            </div>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12 padding-zero">
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="" name="total_revenue" placeholder="Total Revenue" autocomplete="off" class="dis form-control margin_top_input" value="<?php if (isset($profit_result['profit'])) {
                                                                                                                                                                                                echo $profit_result['profit'];
                                                                                                                                                                                            } else {
                                                                                                                                                                                                echo 0;
                                                                                                                                                                                            } ?>">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="" id="recive" name="recive" placeholder="Total Recive" autocomplete="off" class="dis form-control margin_top_input" value="<?php if (isset($profit_take_result['profit'])) {
                                                                                                                                                                                                    echo $profit_take_result['profit'];
                                                                                                                                                                                                } else {
                                                                                                                                                                                                    echo 0;
                                                                                                                                                                                                } ?>">
                                ...
                                <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" disabled="" id="pending" name="pending" placeholder="Total Recive" autocomplete="off" class="dis form-control margin_top_input" value="<?php if (isset($profit_result['profit'])) {
                                                                                                                                                                                                        echo $profit_result['profit'] - $profit_take_result['profit'];
                                                                                                                                                                                                    } else {
                                                                                                                                                                                                        echo 0;
                                                                                                                                                                                                    } ?>">
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Received Payment
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Received Date
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        ?>
                                            <tr class="gradeX odd">
                                                ...
                                                <td class="hidden-phone">
                                                    <?php echo $getcurrency['value'] . ' ' . $result->profit; ?></td>
                                                <td class="service">
                                                    <?php echo date('d-M-Y', strtotime($result->dt_created)); ?></td>
                    ...
                    <div class="panel-body">
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example1" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">

                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Customer Name
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Order No
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Order Date
                                            </th>

                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Order Ammount
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Profit
                                            </th>
                                        </tr>
                                    </thead>
                                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                                        ...
                                        ?>
                                            <tr class="gradeX odd">
                                                ...
                                                <td class="hidden-phone"><?php echo $result->fname . ' ' . $result->lname; ?>
                                                </td>
                                                ...
                                                <td class="total"><?php echo $getcurrency['value'] . ' ' . $result->total; ?>
                                                </td>
                                                <td class="hidden-phone">
                                                    <?php echo $getcurrency['value'] . ' ' . $profit['profit']; ?></td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
                                </table>
