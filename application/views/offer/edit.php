                ...
                <section class="panel">
                    ...
                    <form id="Edit" method="post" enctype="multipart/form-data" action="<?= $FormAction ?>">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12 padding-zero offer-date-picker-div">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="branch" id="branch1" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                                    ...
                                                    <?php foreach ($branchList as $key => $value) : ?>
                                                        ...
                                                        <option value="<?= base_url() . 'offer/edit/' . $value->id ?>" <?= ($value->id == $this->uri->segment(3)) ? "SELECTED" : "" ?>>
                                                            <?= $value->name ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="offer_percent" name="offer_percent" class="form-control" value="<?= $editRecord[0]->offer_percent ?>" <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="start_date" name="start_date" class="form-control datetime" <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?> value="<?= date('m/d/Y', strtotime($editRecord[0]->start_date)) ?>" autocomplete="off">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="end_date" name="end_date" class="form-control datetime_end" <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?> value="<?= date('m/d/Y', strtotime($editRecord[0]->end_date)) ?>" autocomplete="off">
                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example_product_offer" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Rendering engine: activate to sort column ascending" style="width: 80px;">
                                                Select
                                                <!-- <input type="checkbox" class="checkboxMain"> -->
                                            </th>

                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">Product Name
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">price
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">discount (%)
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">Unit
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">weight
                                            </th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 180px;">Package
                                            </th>
                                        </tr>
                                    </thead>
                                        ...
                                        <?php foreach ($producList as $result) { ?>
                                            <tr class="gradeX odd">
                                                <td class="hidden-phone">
                                                    <?php if ($result->id) { ?>
                                                        <input type="checkbox" name="" id='iId' value="<?php echo $result->id; ?>" class="checkbox_user checked_id" <?= (in_array($result->id, $offerDetails) ? "checked" : "") ?>>
                                                    <?php } ?>
                                                </td>
                                    ...
                                    <div class="modal fade" id="myModal" role="dialog">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header select-product-modal">
