            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                ...
                                href="<?php echo base_url() . 'offer'; ?>">List</a> /Add </a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                    ...
                    <form id="frmAddEdit" method="post" enctype="multipart/form-data" action="<?= $FormAction ?>">
                        ...
                        <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="branch" id="branch1"
                                                    ...
                                                    <<?php foreach ($branchList as $key => $value) : ?> <!-- <option
                                                        value="<?= $value->id ?>"><?= $value->name ?></option> -->
                                                        <option value="<?= base_url() . 'offer/add/' . $value->id ?>"
                                                            <?= ($value->id == $this->uri->segment(3)) ? "SELECTED" : "" ?>>
                                                            <?= $value->name ?></option>
                                                        <?php endforeach ?>
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="offer_title" name="offer_title"
                                                    class="form-control"
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                                <label for="offer_title" style="color: red"
                                                    class="error"><?php echo @form_error('offer_title'); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="offer_percent" class="form-control"
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="start_date" name="start_date"
                                                    ...
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>
                                                    autocomplete="off">
                                                <label for="start_date" style="color: red"
                                                    class="error"><?php echo @form_error('start_date'); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" id="start_time" name="start_time"
                                                    class="form-control"
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                                <label for="start_time" style="color: red"
                                                    class="error"><?php echo @form_error('start_time'); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="end_date" name="end_date"
                                                    class="form-control datetime_end"
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>
                                                    autocomplete="off">
                                                <label for="end_date" style="color: red"
                                                    class="error"><?php echo @form_error('end_date'); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="time" id="end_time" name="end_time" class="form-control"
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                                <label for="end_time" style="color: red"
                                                    class="error"><?php echo @form_error('end_time'); ?></label>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="file" name="offer_image" class="form-control"
                                                    onchange="app_readUploadedImage(this)" size="20" id="offer_image" /
                                                    <?= ($this->uri->segment(3) == '') ? 'disabled' : '' ?>>
                                                <div id='show1' class=""
                                                    style="width: 150px;height: 150px; margin-top: 20px; display: none">
                            ...
                            <table class="display table table-bordered table-striped dataTable"
                                id="example_product_offer" aria-describedby="example_info">
                                <thead>
                                    <tr role="row">
                                ...
                                <tbody role="alert" aria-live="polite" aria-relevant="all">
                                    ...
                                    <tr class="gradeX odd">
                                        <td class="hidden-phone">
                                            <?php if ($result->id) { ?>
                                            <input type="checkbox" name="" id='iId' value="<?php echo $result->id; ?>"
                                                class="checkbox_user checked_id">
                                            <?php } ?>
                                        </td>
                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <a href="<?= base_url() . 'offer' ?>" style="float: right; margin-right: 10px;"
                                ...
                                <input type="button" class="btn btn-info pull-right margin_top_label" id="add"
                                    value="Add">
                                <!-- </span> -->
                            </div>
                        </div>
                                            ...
                                            <div class="modal-header select-product-modal">
                                                ...
                                                <table>
                                                    ...
                                                    <tbody id='append_selected_varient'>
                                                        <tr>
                                                            <td colspan="4" class="last-td"><button type="submit"
