    ...
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <!--breadcrumbs start -->
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a href="<?php echo base_url() . 'admin/dashboard'; ?>">Home</a> / Delivery</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                        ...
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'delivery/delivery_user'; ?>" class="btn btn-primary">Add Delivery Person</a>

                                </div>
                                <table class="display table table-bordered table-striped dataTable" id="example_delivery" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending" style="width: 200px;">Name
                                            </th>
                                            ...
                                            <th class="hidden-phone sorting_desc" role="columnheader" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="CSS grade: activate to sort column ascending" style="width: 100px;">Status
                                            </th>
                                            ...
                                            <tr class="gradeX odd">
                                                ...
                                                <td>
                                                    <?php if ($result->status == 1) { ?>
                                                        ...
                                                        <input type="button" data-val="<?php echo $this->utility->encode($result->id); ?>" class="vendor_status btn btn-primary btn-xs" value="Active">

                                                    <?php } else { ?>
                                                        <input type="button" data-val="<?php echo $this->utility->encode($result->id); ?>" class="vendor_status btn btn-danger btn-xs" value="In-active">
                                                    <?php } ?>
                                                </td>
                                                <td>

                                                    <a href="<?php echo base_url() . 'delivery/delivery_user?id=' . $this->utility->encode($result->id); ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
