...
<head>
    ...
    <link href="<?php echo base_url(); ?>public/social_posts/social_post.css" rel="stylesheet" />
    <?php if (isset($css)) { ?>
                    ...
                    if ($this->session->userdata('flag') !== '' && $this->session->userdata('type') == '1') { ?>
                        <li>
                            <select class="form-control change-vendor">
                                <option value="vendor_admin" <?= ($this->session->userdata('vendor_admin') == '1') ? "SELECTED" : "" ?>>Vendor Admin
                                </option>
                                <?php foreach ($AllVendor = getAllBranch() as $key => $value) { ?>
                                    <option value="<?= $value->id ?>" <?= ($this->session->userdata('id') == $value->id) ? "SELECTED" : "" ?>>
                                        <?= $value->name ?></option>
                                <?php } ?>
                            </select>
                        </li>
