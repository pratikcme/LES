...
<head>
    ...
    <link rel="shortcut icon" href="<?= ($this->siteFevicon != '') ? $this->siteFevicon : $this->siteLogo; ?>"
        type="image/gif" sizes="8x8">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Open+Sans:wght@300;400;500;600;700;800&display=swap"
        rel="stylesheet">
    <?php } ?>
    <script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=AIzaSyBW43KgTNs_Kusuvbian6KYGi_QzXOLS4w"
    ...
    <section id="container">
        ...
        <header class="header white-bg border_top">
            ...
            <div class="top-nav ">
                ...
                <div class="notif">
                    <div class="<?= (count($this->adminNotification) > 0) ? "btn__badge" : "" ?> pulse-button"
                        id="notify-dot"></div>
                    <i class="fas fa-bell dropdown-toggle notify-dropdown"></i>
                    <ul class="dropdown notify-drop <?= (count($this->adminNotification) == "0") ? 'ishave' : ''   ?>"
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li>
                        <select class="form-control change-vendor">
                            <option value="vendor_admin"
                                <?= ($this->session->userdata('vendor_admin') == '1') ? "SELECTED" : "" ?>>Vendor Admin
                            </option>
                            <?php foreach ($AllVendor = getAllBranch() as $key => $value) { ?>
                            <option value="<?= $value->id ?>"
                                <?= ($this->session->userdata('id') == $value->id) ? "SELECTED" : "" ?>>
                                <?= $value->name ?></option>
                            <?php } ?>
                        </select>
                    </li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="<?php echo base_url() . 'admin/update_password'; ?>"><i
                                        class="fa fa-lock"></i>Change </br> Password</a></li>
                            <?php if ($vendor_id != 0) { ?>
                ...
                <ul class="sidebar-menu" id="nav-accordion">
                    ...
                    <li style="display: none;">
                        <a href="#">
                            ...
                            <div class="tgl-group">
                                <input class='tgl tgl-light' id='display-address' type='checkbox' <?php if ($getdata['0']->delivery_by == '1') {
        ...
        <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jqueryui/1.9.2/jquery.ui.mouse.min.js"
            integrity="sha512-G0ZcUFkeiDbEYpvL2I6p3pLRoMO3aH/cqAWwN5h2cODGfwk7KsBYcmLf3QWJK85faTBmsrvpbJhku2MRk2mgcw=="
            crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
        <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery.pep/0.4.0/jquery.pep.min.js"
            integrity="sha512-PqqnNVs8iq01OKqtIsqIg7l/5/+tzfwyCzoE+XWKaCNIaOZyH8S0c0+tcoovAYd8YMQitj5nLcxz+KAYGaiXRA=="
            crossorigin="anonymous" referrerpolicy="no-referrer"></script> -->
        <script src="https://unpkg.com/draggabilly@2/dist/draggabilly.pkgd.min.js"></script>
        <script src="<?= base_url() . 'public/js/jquery.udraggable.js' ?>"></script>
        <!--sidebar end-->
