        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input type="text" name="otp" id="otp" class="form-control" value="" required
                        placeholder="4-PIN OTP">
                    <input type="hidden" value="" id="project_id" name="project_id">
                </div>
                <span style="color: red" id="error"></span>
            </div>
            <div class="modal-footer">
                <input type="submit" id="submitotp" style="color:white;background: #0f3c4a"
                    class="btn  btn-circle submitBtn" value="Submit" name="submit" />
            </div>
        </div>
    </div>
</div>
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.status == 1) {
                        ...
                        bootbox.alert("Order(s) has been deleted successfully.",
                    function() {
                            window.location.reload(true);
                        });
                    } else {
