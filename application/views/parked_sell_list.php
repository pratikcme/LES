                                ...
                                <table class="display table table-bordered table-striped dataTable" id="example_parked"
                                    ...
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                ...
                                                style="width: 305px;">Sold By</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Customer</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Sub-Total</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Discount(%)</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                                style="width: 305px;">Discount Price</th>
                                            <th class="sorting" role="columnheader" tabindex="0" aria-controls="example"
                                                rowspan="1" colspan="1"
                                                aria-label="Rendering engine: activate to sort column ascending"
                                    ...
                                    <tbody role="alert" aria-live="polite" aria-relevant="all">
                                        ...
                                        <tr class="gradeX odd">
                                            ...
                                            <td class="">
                                                <a href="javascript:;"
                                                    onclick="single_delete(<?php echo $order->id; ?>)"
                                                ...
                                                <a href="<?php echo base_url() . 'sell_development/index?parkedId=' . base64_encode($order->id); ?>"
                                                    class="btn btn-info btn-xs"><i class="fa fa-check-square "></i></a>
                                            </td>
                                        ...
                                        ?>
                                        <tr>
                                            <td colspan="8" class="text-center"> No Parked Sells! </td>
                                        </tr>
                                        <?php
                                        }
                                        ?>
