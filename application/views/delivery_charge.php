            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <section class="panel">
                    ...
                    <form role="form" method="post"
                        action="<?php echo base_url() . 'delivery_charge/delivery_charge_add'; ?>" name="city_form"
                        id="city_form">
                        <input type="hidden" id="id" name="id"
                            value="<?= ($result['id'] != '') ? $result['id'] : ''; ?>">
                                ...
                                <div class="col-lg-12 col-md-6 col-sm-6 col-xs-6">
                                    <div class="form-group">
                                        <div>
                                            ...
                                            <input type="text" class="start form-control margin_top_input commonclass"
                                                id="start_range" onkeypress="validates(event)" name="start_range"
                                                placeholder="Start Range" value="<?php echo $result['start_range']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="end form-control margin_top_input commonclass"
                                            id="end_range" name="end_range" placeholder="End Range"
                                            onkeypress="validates(event)" value="<?php echo $result['end_range']; ?>">
                                    ...
                                    <div class="form-group">
                                        <label for="price" class="margin_top_label">Price<span class="required">
                                                <input type="text"
                                                    class="price form-control margin_top_input commonclass" id="price"
