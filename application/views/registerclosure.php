                                    ...
                                    <div class="detail_info_of_clouser">
                                        ...
                                        <div class="col-md-3 col-lg-3 col-sm-3 col-xs-12">
                                            <div class="outlet_clouser">
                                                ...
                                                <p><?php if (!empty($register_result)) {
                                                        echo date('l, jS F, Y, g:ia', $register_result[0]->closing_time);
                                                    } else {
                                                        echo ' - ';
                                                    }  ?>
                                                </p>
                                                    ...
                                                    <div class="drawer_cash">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="summary_cash">
                                                                ...
                                                                <p><?php if (!empty($register_result[0]->credit_card_expected)) {
                                                        ...
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="summary_cash">
                                                                <p><?php if (!empty($register_result[0]->credit_card_counted)) {
                                                ...
                                                <div class="col-lg-8 col-md-8 col-sm-7 col-xs-12 res_no_padd">
                                                    <div class="drawer_cash">
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="summary_cash">
                                                                <p id="total_expected">
                                                                    <?php echo isset($register_result[0]->credit_card_expected) ?  number_format((float)$register_result[0]->credit_card_expected + $register_result[0]->cash_amount_expected) : " 0.00" ?>
                                                                </p>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                                            <div class="summary_cash">
                                                                <p id="total_counted">
                                                                    <?php echo
                                                                    numberFormat(numberFormat($register_result[0]->credit_card_counted) + numberFormat($register_result[0]->counted))
                                                                    ?>
                                                                </p>
                                                            </div>
                                                        </div>
