...
<div class="mobile-navbar">
    <div class="container">
        <div class="mobile-nav">
            <ul>
                <li><a href="<?= base_url() ?>home"><span><i class="fa fa-home"
                                aria-hidden="true"></i></span><?= $this->lang->line('home') ?></a></li>
                <li><a href="<?= base_url() ?>products"><span><i
                                class="fa-solid fa-store"></i></span><?= $this->lang->line('Shop') ?></a></li>
                <li><a href="<?= base_url() ?>login"><span><i
                                class="fa-regular fa-user"></i></span><?= $this->lang->line('About Us') ?></a></li>
                <li><a href="<?= base_url() ?>contact"><span><i
                                class="fa-regular fa-circle-user"></i></span><?= $this->lang->line('Contact Us') ?></a>
                </li>
            </ul>
        </div>
    </div>
