            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <ul class="breadcrumb">
                    <li class="active"><a href=""><i class="fa fa-home"></i> <a
                                href="<?php echo base_url().'admin/index'; ?>">Home</a> / Category</a></li>
                </ul>
                <!--breadcrumbs end -->
            </div>
        </div>
                        ...
                        <div class="adv-table">
                            <div id="example_wrapper" class="dataTables_wrapper form-inline" role="grid">
                                <div class="panel-body padding-zero" style="float: right">
                                    <a href="<?php echo base_url() . 'category/category_profile'; ?>"
                                ...
                                <table class="display table table-bordered table-striped dataTable"
                                    id="example_category" aria-describedby="example_info">
                                    <thead>
                                        <tr role="row">
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            if (data.status == 1) {
                    ...
                    if (confirmed == true) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                bootbox.alert("Category is deleted..",
                                    function() {
                                        window.location.reload(true);
                                    });
                            }
                ...
                bootbox.alert("The category '" + a +
                    "', is maped with brand. Please deselect it and try again.",
                    function() {});
            } else if (data.status == 3) {
                bootbox.alert("The category '" + a +
                    "', is maped with product. Please deselect it and try again.",
                    function() {});
            } else if (data.status == 4) {
                bootbox.alert("The category '" + a +
                    "', is maped with subcategory. Please deselect it and try again.",
                    function() {});
            } else {
