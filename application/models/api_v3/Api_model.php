...
class Api_model extends My_model
{
    ...
    public function user_register($postData)
    {
        ...
        if (empty($getUser)) {
            ...
            $data['update']['fname'] =  (isset($postData['fname'])) ?  $postData['fname'] : $getUser[0]->fname;
            $data['update']['lname'] = (isset($postData['lname'])) ?   $postData['lname'] : $getUser[0]->lname ;
            $data['update']['email'] = (isset($postData['email'])) ?   $postData['email'] : $getUser[0]->email;
            $data['table'] = 'user';
