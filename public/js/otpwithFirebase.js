 var firebaseConfig = {
  apiKey: "AIzaSyCu1lTfOc6swu1tzVJVLJGrXt8ZX_aEmG0",
  authDomain: "smsauthantication-4aff9.firebaseapp.com",
  projectId: "smsauthantication-4aff9",
  storageBucket: "smsauthantication-4aff9.appspot.com",
  messagingSenderId: "760004252061",
  appId: "1:760004252061:web:c07164855ca1f50bb41f74",
  measurementId: "G-9D5Q0C6F35",
};
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.success == "1") {
                    ...
                    // Handle failure
                    $(".mobile_verification").html("This mobile number is linked with another account");
