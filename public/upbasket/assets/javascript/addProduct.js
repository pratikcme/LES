    ...
    if (product_varient_id != '') {
      ...
      $.ajax({
        ...
        success: function (output) {
          ...
          alert('< div class="pro-hearticon wishlist-icon" data-product_id="' + output.product_id + '" data-product_weight_id="' + output.product_variant_id + '">< i class="fa-regular fa-heart ' + output.isInWishList + '"></i ></div >')
